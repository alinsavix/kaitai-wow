...
class Skin(KaitaiStruct):
    ...
    def _read(self):
        ...
        if True:
            self.ofs_indices = self._io.read_u4le()
        ...
        if True:
            self.ofs_submeshes = self._io.read_u4le()

        if True:
            self.num_batches = self._io.read_u4le()

        if True:
            self.ofs_batches = self._io.read_u4le()

        self.bone_count_max = self._io.read_u4le()
        if True:
            self.num_shadow_batches = self._io.read_u4le()

        if True:
            self.ofs_shadow_batches = self._io.read_u4le()
    ...
    class M2sequence(KaitaiStruct):
        ...
        def _read(self):
            self.id = KaitaiStream.resolve_enum(Skin.AnimNames, self._io.read_u2le())
            ...
            self.flags = Skin.M2sequenceFlags(_io__raw_flags, self, self._root)
    ...
    class M2material(KaitaiStruct):
        ...
        def _read(self):
            ...
            _io__raw_flags = KaitaiStream(BytesIO(self._raw_flags))
            self.flags = Skin.M2materialFlags(_io__raw_flags, self, self._root)
    ...
    class M2texture(KaitaiStruct):
        ...
        def _read(self):
            self.type = KaitaiStream.resolve_enum(Skin.M2textureTypes, self._io.read_u4le())
            self._raw_flags = self._io.read_bytes(4)
            _io__raw_flags = KaitaiStream(BytesIO(self._raw_flags))
            self.flags = Skin.M2textureFlags(_io__raw_flags, self, self._root)
            if True:
    ...
    class M2compbone(KaitaiStruct):
        ...
        def _read(self):
            ...
            self._raw_flags = self._io.read_bytes(4)
            _io__raw_flags = KaitaiStream(BytesIO(self._raw_flags))
            self.flags = Skin.M2compboneFlags(_io__raw_flags, self, self._root)
    ...
    class M2track(KaitaiStruct):
        ...
        def _read(self):
            self.interpolation_type = KaitaiStream.resolve_enum(Skin.M2trackInterpolationTypes, self._io.read_u2le())
        ...
        def timestamps(self):
            ...
            if True:
                ...
                for i in range(self.num_timestamps):
                    self._m_timestamps[i] = Skin.U4Nested(self._io, self, self._root)
    ...
    def bones(self):
        ...
        if True:
            ...
            for i in range(self.num_bones):
                self._m_bones[i] = Skin.Ubyte4(self._io, self, self._root)
    ...
    @property
    def batches(self):
        if hasattr(self, '_m_batches'):
            return self._m_batches if hasattr(self, '_m_batches') else None

        if True:
            _pos = self._io.pos()
            self._io.seek(self.ofs_batches)
            self._m_batches = [None] * (self.num_batches)
            for i in range(self.num_batches):
                self._m_batches[i] = Skin.M2batch(self._io, self, self._root)
    ...
    def indices(self):
        ...
        if True:
            _pos = self._io.pos()
            self._io.seek(self.ofs_indices)
            self._m_indices = [None] * (self.num_indices)
    ...
    def vertices(self):
        ...
        if True:
            ...
            for i in range(self.num_vertices):
                self._m_vertices[i] = self._io.read_u2le()
    ...
    def shadow_batches(self):
        if hasattr(self, '_m_shadow_batches'):
            return self._m_shadow_batches if hasattr(self, '_m_shadow_batches') else None

        if True:
            _pos = self._io.pos()
            self._io.seek(self.ofs_shadow_batches)
            self._m_shadow_batches = [None] * (self.num_shadow_batches)
            for i in range(self.num_shadow_batches):
                self._m_shadow_batches[i] = Skin.M2shadowbatch(self._io, self, self._root)
    ...
    @property
    def submeshes(self):
        if hasattr(self, '_m_submeshes'):
            return self._m_submeshes if hasattr(self, '_m_submeshes') else None

        if True:
            _pos = self._io.pos()
            self._io.seek(self.ofs_submeshes)
            self._m_submeshes = [None] * (self.num_submeshes)
            for i in range(self.num_submeshes):
                self._m_submeshes[i] = Skin.M2skinsection(self._io, self, self._root)
