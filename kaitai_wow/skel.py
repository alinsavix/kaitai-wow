...
class Skel(KaitaiStruct):
    ...
    class ChunkSka1(KaitaiStruct):
        ...
        def _read(self):
            ...
            if True:
                self.num_attachment_lookup_table = self._io.read_u4le()

            if True:
                self.ofs_attachment_lookup_table = self._io.read_u4le()


        @property
        def attachment_lookup_table(self):
            if hasattr(self, '_m_attachment_lookup_table'):
                return self._m_attachment_lookup_table if hasattr(self, '_m_attachment_lookup_table') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_attachment_lookup_table)
                self._m_attachment_lookup_table = [None] * (self.num_attachment_lookup_table)
                for i in range(self.num_attachment_lookup_table):
                    self._m_attachment_lookup_table[i] = self._io.read_s2le()
        ...
        def attachments(self):
            ...
            if True:
                ...
                for i in range(self.num_attachments):
                    self._m_attachments[i] = Skel.M2attachment(self._io, self, self._root)
    ...
    class ChunkSkpd(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.parent_skel_file_data_id = self._io.read_u4le()
    ...
    class M2sequence(KaitaiStruct):
        ...
        def _read(self):
            self.id = KaitaiStream.resolve_enum(Skel.AnimNames, self._io.read_u2le())
            ...
            self.flags = Skel.M2sequenceFlags(_io__raw_flags, self, self._root)
    ...
    class M2material(KaitaiStruct):
        ...
        def _read(self):
            ...
            _io__raw_flags = KaitaiStream(BytesIO(self._raw_flags))
            self.flags = Skel.M2materialFlags(_io__raw_flags, self, self._root)
    ...
    class ChunkSkb1(KaitaiStruct):
        ...
        def _read(self):
            ...
            if True:
                self.num_key_bone_lookup = self._io.read_u4le()

            if True:
                self.ofs_key_bone_lookup = self._io.read_u4le()
        ...
        def bones(self):
            ...
            if True:
                ...
                for i in range(self.num_bones):
                    self._m_bones[i] = Skel.M2compbone(self._io, self, self._root)
        ...
        @property
        def key_bone_lookup(self):
            if hasattr(self, '_m_key_bone_lookup'):
                return self._m_key_bone_lookup if hasattr(self, '_m_key_bone_lookup') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_key_bone_lookup)
                self._m_key_bone_lookup = [None] * (self.num_key_bone_lookup)
                for i in range(self.num_key_bone_lookup):
                    self._m_key_bone_lookup[i] = self._io.read_s2le()
    ...
    class ChunkSks1(KaitaiStruct):
        ...
        def _read(self):
            ...
            if True:
                self.num_sequence_lookups = self._io.read_u4le()

            if True:
                self.ofs_sequence_lookups = self._io.read_u4le()
        ...
        def global_loops(self):
            ...
            if True:
                ...
                for i in range(self.num_global_loops):
                    self._m_global_loops[i] = Skel.M2loop(self._io, self, self._root)
        ...
        @property
        def sequence_lookups(self):
            if hasattr(self, '_m_sequence_lookups'):
                return self._m_sequence_lookups if hasattr(self, '_m_sequence_lookups') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_sequence_lookups)
                self._m_sequence_lookups = [None] * (self.num_sequence_lookups)
                for i in range(self.num_sequence_lookups):
                    self._m_sequence_lookups[i] = self._io.read_s2le()
        ...
        def sequences(self):
            ...
            if True:
                ...
                for i in range(self.num_sequences):
                    self._m_sequences[i] = Skel.M2sequence(self._io, self, self._root)
    ...
    class M2texture(KaitaiStruct):
        ...
        def _read(self):
            self.type = KaitaiStream.resolve_enum(Skel.M2textureTypes, self._io.read_u4le())
            self._raw_flags = self._io.read_bytes(4)
            _io__raw_flags = KaitaiStream(BytesIO(self._raw_flags))
            self.flags = Skel.M2textureFlags(_io__raw_flags, self, self._root)
            if True:
    ...
    class M2compbone(KaitaiStruct):
        ...
        def _read(self):
            ...
            self._raw_flags = self._io.read_bytes(4)
            _io__raw_flags = KaitaiStream(BytesIO(self._raw_flags))
            self.flags = Skel.M2compboneFlags(_io__raw_flags, self, self._root)
    ...
    class M2track(KaitaiStruct):
        ...
        def _read(self):
            self.interpolation_type = KaitaiStream.resolve_enum(Skel.M2trackInterpolationTypes, self._io.read_u2le())
        ...
        def timestamps(self):
            ...
            if True:
                ...
                for i in range(self.num_timestamps):
                    self._m_timestamps[i] = Skel.U4Nested(self._io, self, self._root)
    ...
    class AnimFileId(KaitaiStruct):
        ...
        def _read(self):
            self.anim_id = KaitaiStream.resolve_enum(Skel.AnimNames, self._io.read_u2le())
