...
class M2(KaitaiStruct):
    ...
    def _read(self):
        self.md21magic = self._io.read_bytes(4)
        if not self.md21magic == b"\x4D\x44\x32\x31":
            raise kaitaistruct.ValidationNotEqualError(b"\x4D\x44\x32\x31", self.md21magic, self._io, u"/seq/0")
        self.headersize = self._io.read_u4le()
        self._raw_model = self._io.read_bytes(self.headersize)
        _io__raw_model = KaitaiStream(BytesIO(self._raw_model))
        self.model = M2.ChunkMd20(_io__raw_model, self, self._root)
        self.chunks = []
        i = 0
        while True:
    ...
    class Chunk(KaitaiStruct):
        ...
        def _read(self):
            ...
            if _on == u"PGD1":
                ...
                self.chunk_data = M2.ChunkPgd1(_io__raw_chunk_data, self, self._root)
            elif _on == u"DETL":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = M2.ChunkDetl(_io__raw_chunk_data, self, self._root)
            elif _on == u"LDV1":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = M2.ChunkLdv1(_io__raw_chunk_data, self, self._root)
            elif _on == u"AFID":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = M2.ChunkAfid(_io__raw_chunk_data, self, self._root)
            elif _on == u"TXAC":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = M2.ChunkTxac(_io__raw_chunk_data, self, self._root)
            elif _on == u"TXID":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = M2.ChunkTxid(_io__raw_chunk_data, self, self._root)
            elif _on == u"EXP2":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = M2.ChunkExp2(_io__raw_chunk_data, self, self._root)
            elif _on == u"SFID":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = M2.ChunkSfid(_io__raw_chunk_data, self, self._root)
            else:
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = M2.Noop(_io__raw_chunk_data, self, self._root)
    ...
    class M2sequence(KaitaiStruct):
        ...
        def _read(self):
            self.id = KaitaiStream.resolve_enum(M2.AnimNames, self._io.read_u2le())
            ...
            self.flags = M2.M2sequenceFlags(_io__raw_flags, self, self._root)
    ...
    class ChunkPgd1(KaitaiStruct):
        ...
        def _read(self):
            if True:
                self.num_p_g_d_v1 = self._io.read_u4le()

            if True:
                self.ofs_p_g_d_v1 = self._io.read_u4le()


        @property
        def p_g_d_v1(self):
            if hasattr(self, '_m_p_g_d_v1'):
                return self._m_p_g_d_v1 if hasattr(self, '_m_p_g_d_v1') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_p_g_d_v1)
                self._m_p_g_d_v1 = [None] * (self.num_p_g_d_v1)
                for i in range(self.num_p_g_d_v1):
                    self._m_p_g_d_v1[i] = M2.Pgd1Entry(self._io, self, self._root)
    ...
    class M2material(KaitaiStruct):
        ...
        def _read(self):
            ...
            _io__raw_flags = KaitaiStream(BytesIO(self._raw_flags))
            self.flags = M2.M2materialFlags(_io__raw_flags, self, self._root)
    ...
    class M2texture(KaitaiStruct):
        ...
        def _read(self):
            self.type = KaitaiStream.resolve_enum(M2.M2textureTypes, self._io.read_u4le())
            self._raw_flags = self._io.read_bytes(4)
            _io__raw_flags = KaitaiStream(BytesIO(self._raw_flags))
            self.flags = M2.M2textureFlags(_io__raw_flags, self, self._root)
            if True:
    ...
    class M2compbone(KaitaiStruct):
        ...
        def _read(self):
            ...
            self._raw_flags = self._io.read_bytes(4)
            _io__raw_flags = KaitaiStream(BytesIO(self._raw_flags))
            self.flags = M2.M2compboneFlags(_io__raw_flags, self, self._root)
    ...
    class ChunkMd20(KaitaiStruct):
        ...
        def _read(self):
            ...
            if True:
                self.num_name = self._io.read_u4le()
            ...
            self._raw_flags = self._io.read_bytes(4)
            _io__raw_flags = KaitaiStream(BytesIO(self._raw_flags))
            self.flags = M2.Md20GlobalFlags(_io__raw_flags, self, self._root)
            if True:
                self.num_global_loops = self._io.read_u4le()

            if True:
                self.ofs_global_loops = self._io.read_u4le()

            if True:
                self.num_sequences = self._io.read_u4le()

            if True:
                self.ofs_sequences = self._io.read_u4le()

            if True:
                self.num_sequence_idx_hash_by_id = self._io.read_u4le()

            if True:
                self.ofs_sequence_idx_hash_by_id = self._io.read_u4le()
            ...
            if True:
                self.num_bone_indices_by_id = self._io.read_u4le()

            if True:
                self.ofs_bone_indices_by_id = self._io.read_u4le()
            ...
            if True:
                self.ofs_colors = self._io.read_u4le()
            ...
            if True:
                self.num_texture_weights = self._io.read_u4le()

            if True:
                self.ofs_texture_weights = self._io.read_u4le()

            if True:
                self.num_texture_transforms = self._io.read_u4le()

            if True:
                self.ofs_texture_transforms = self._io.read_u4le()

            if True:
                self.num_texture_replaceable_lookup = self._io.read_u4le()

            if True:
                self.ofs_texture_replaceable_lookup = self._io.read_u4le()
            ...
            if True:
                self.num_bone_lookup = self._io.read_u4le()

            if True:
                self.ofs_bone_lookup = self._io.read_u4le()

            if True:
                self.num_texture_lookup = self._io.read_u4le()

            if True:
                self.ofs_texture_lookup = self._io.read_u4le()

            if True:
                self.num_texture_unit_lookup = self._io.read_u4le()

            if True:
                self.ofs_texture_unit_lookup = self._io.read_u4le()

            if True:
                self.num_texture_transparency_lookup = self._io.read_u4le()

            if True:
                self.ofs_texture_transparency_lookup = self._io.read_u4le()

            if True:
                self.num_uvanimlookup = self._io.read_u4le()

            if True:
                self.ofs_uvanimlookup = self._io.read_u4le()
            ...
            if True:
                self.num_collision_indices = self._io.read_u4le()

            if True:
                self.ofs_collision_indices = self._io.read_u4le()

            if True:
                self.num_collision_positions = self._io.read_u4le()

            if True:
                self.ofs_collision_positions = self._io.read_u4le()

            if True:
                self.num_collision_face_normals = self._io.read_u4le()

            if True:
                self.ofs_collision_face_normals = self._io.read_u4le()

            if True:
                self.num_attachments = self._io.read_u4le()

            if True:
                self.ofs_attachments = self._io.read_u4le()

            if True:
                self.num_attachment_lookup = self._io.read_u4le()

            if True:
                self.ofs_attachment_lookup = self._io.read_u4le()
            ...
            if True:
                self.ofs_lights = self._io.read_u4le()

            if True:
                self.num_cameras = self._io.read_u4le()

            if True:
                self.ofs_cameras = self._io.read_u4le()

            if True:
                self.num_camera_lookup = self._io.read_u4le()

            if True:
                self.ofs_camera_lookup = self._io.read_u4le()

            if True:
                self.num_ribbon_emitters = self._io.read_u4le()

            if True:
                self.ofs_ribbon_emitters = self._io.read_u4le()

            if True:
                self.num_particle_emitters = self._io.read_u4le()

            if True:
                self.ofs_particle_emitters = self._io.read_u4le()

            if self.flags.use_texture_combiner_combos:
                self.num_texture_combiner_combos = self._io.read_u4le()

            if self.flags.use_texture_combiner_combos:
                self.ofs_texture_combiner_combos = self._io.read_u4le()


        @property
        def ribbon_emitters(self):
            if hasattr(self, '_m_ribbon_emitters'):
                return self._m_ribbon_emitters if hasattr(self, '_m_ribbon_emitters') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_ribbon_emitters)
                self._m_ribbon_emitters = [None] * (self.num_ribbon_emitters)
                for i in range(self.num_ribbon_emitters):
                    self._m_ribbon_emitters[i] = M2.M2ribbon(self._io, self, self._root)
        ...
        @property
        def texture_unit_lookup(self):
            if hasattr(self, '_m_texture_unit_lookup'):
                return self._m_texture_unit_lookup if hasattr(self, '_m_texture_unit_lookup') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_texture_unit_lookup)
                self._m_texture_unit_lookup = [None] * (self.num_texture_unit_lookup)
                for i in range(self.num_texture_unit_lookup):
                    self._m_texture_unit_lookup[i] = self._io.read_u2le()
        ...
        def bones(self):
            ...
            if True:
                ...
                for i in range(self.num_bones):
                    self._m_bones[i] = M2.M2compbone(self._io, self, self._root)
        ...
        def attachment_lookup(self):
            if hasattr(self, '_m_attachment_lookup'):
                return self._m_attachment_lookup if hasattr(self, '_m_attachment_lookup') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_attachment_lookup)
                self._m_attachment_lookup = [None] * (self.num_attachment_lookup)
                for i in range(self.num_attachment_lookup):
                    self._m_attachment_lookup[i] = self._io.read_u2le()
        ...
        @property
        def sequence_idx_hash_by_id(self):
            if hasattr(self, '_m_sequence_idx_hash_by_id'):
                return self._m_sequence_idx_hash_by_id if hasattr(self, '_m_sequence_idx_hash_by_id') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_sequence_idx_hash_by_id)
                self._m_sequence_idx_hash_by_id = [None] * (self.num_sequence_idx_hash_by_id)
                for i in range(self.num_sequence_idx_hash_by_id):
                    self._m_sequence_idx_hash_by_id[i] = self._io.read_u2le()
        ...
        def lights(self):
            ...
            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_lights)
                self._m_lights = [None] * (self.num_lights)
                for i in range(self.num_lights):
                    self._m_lights[i] = M2.M2light(self._io, self, self._root)
        ...
        def global_loops(self):
            if hasattr(self, '_m_global_loops'):
                return self._m_global_loops if hasattr(self, '_m_global_loops') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_global_loops)
                self._m_global_loops = [None] * (self.num_global_loops)
                for i in range(self.num_global_loops):
                    self._m_global_loops[i] = M2.M2loop(self._io, self, self._root)
        ...
        @property
        def cameras(self):
            if hasattr(self, '_m_cameras'):
                return self._m_cameras if hasattr(self, '_m_cameras') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_cameras)
                self._m_cameras = [None] * (self.num_cameras)
                for i in range(self.num_cameras):
                    self._m_cameras[i] = M2.M2camera(self._io, self, self._root)
        ...
        @property
        def camera_lookup(self):
            if hasattr(self, '_m_camera_lookup'):
                return self._m_camera_lookup if hasattr(self, '_m_camera_lookup') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_camera_lookup)
                self._m_camera_lookup = [None] * (self.num_camera_lookup)
                for i in range(self.num_camera_lookup):
                    self._m_camera_lookup[i] = self._io.read_u2le()
        ...
        @property
        def texture_transforms(self):
            if hasattr(self, '_m_texture_transforms'):
                return self._m_texture_transforms if hasattr(self, '_m_texture_transforms') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_texture_transforms)
                self._m_texture_transforms = [None] * (self.num_texture_transforms)
                for i in range(self.num_texture_transforms):
                    self._m_texture_transforms[i] = M2.M2texturetransform(self._io, self, self._root)
        ...
        @property
        def bone_lookup(self):
            if hasattr(self, '_m_bone_lookup'):
                return self._m_bone_lookup if hasattr(self, '_m_bone_lookup') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_bone_lookup)
                self._m_bone_lookup = [None] * (self.num_bone_lookup)
                for i in range(self.num_bone_lookup):
                    self._m_bone_lookup[i] = self._io.read_u2le()
        ...
        @property
        def bone_indices_by_id(self):
            if hasattr(self, '_m_bone_indices_by_id'):
                return self._m_bone_indices_by_id if hasattr(self, '_m_bone_indices_by_id') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_bone_indices_by_id)
                self._m_bone_indices_by_id = [None] * (self.num_bone_indices_by_id)
                for i in range(self.num_bone_indices_by_id):
                    self._m_bone_indices_by_id[i] = self._io.read_u2le()
        ...
        @property
        def particle_emitters(self):
            if hasattr(self, '_m_particle_emitters'):
                return self._m_particle_emitters if hasattr(self, '_m_particle_emitters') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_particle_emitters)
                self._m_particle_emitters = [None] * (self.num_particle_emitters)
                for i in range(self.num_particle_emitters):
                    self._m_particle_emitters[i] = M2.M2particle(self._io, self, self._root)
        ...
        def vertices(self):
            ...
            if True:
                ...
                for i in range(self.num_vertices):
                    self._m_vertices[i] = M2.M2vertex(self._io, self, self._root)
        ...
        @property
        def collision_face_normals(self):
            if hasattr(self, '_m_collision_face_normals'):
                return self._m_collision_face_normals if hasattr(self, '_m_collision_face_normals') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_collision_face_normals)
                self._m_collision_face_normals = [None] * (self.num_collision_face_normals)
                for i in range(self.num_collision_face_normals):
                    self._m_collision_face_normals[i] = M2.C3vector(self._io, self, self._root)
        ...
        def textures(self):
            ...
            if True:
                ...
                for i in range(self.num_textures):
                    self._m_textures[i] = M2.M2texture(self._io, self, self._root)
        ...
        @property
        def texture_weights(self):
            if hasattr(self, '_m_texture_weights'):
                return self._m_texture_weights if hasattr(self, '_m_texture_weights') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_texture_weights)
                self._m_texture_weights = [None] * (self.num_texture_weights)
                for i in range(self.num_texture_weights):
                    self._m_texture_weights[i] = M2.M2textureweight(self._io, self, self._root)
        ...
        @property
        def texture_replaceable_lookup(self):
            if hasattr(self, '_m_texture_replaceable_lookup'):
                return self._m_texture_replaceable_lookup if hasattr(self, '_m_texture_replaceable_lookup') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_texture_replaceable_lookup)
                self._m_texture_replaceable_lookup = [None] * (self.num_texture_replaceable_lookup)
                for i in range(self.num_texture_replaceable_lookup):
                    self._m_texture_replaceable_lookup[i] = self._io.read_u2le()
        ...
        def name(self):
            ...
            if True:
                ...
                self._m_name = (self._io.read_bytes(self.num_name)).decode(u"UTF-8")
                self._io.seek(_pos)

            return self._m_name if hasattr(self, '_m_name') else None

        @property
        def texture_lookup(self):
            if hasattr(self, '_m_texture_lookup'):
                return self._m_texture_lookup if hasattr(self, '_m_texture_lookup') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_texture_lookup)
                self._m_texture_lookup = [None] * (self.num_texture_lookup)
                for i in range(self.num_texture_lookup):
                    self._m_texture_lookup[i] = self._io.read_u2le()
        ...
        def colors(self):
            ...
            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_colors)
                self._m_colors = [None] * (self.num_colors)
                for i in range(self.num_colors):
                    self._m_colors[i] = M2.M2color(self._io, self, self._root)
        ...
        @property
        def texture_transparency_lookup(self):
            if hasattr(self, '_m_texture_transparency_lookup'):
                return self._m_texture_transparency_lookup if hasattr(self, '_m_texture_transparency_lookup') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_texture_transparency_lookup)
                self._m_texture_transparency_lookup = [None] * (self.num_texture_transparency_lookup)
                for i in range(self.num_texture_transparency_lookup):
                    self._m_texture_transparency_lookup[i] = self._io.read_u2le()
        ...
        @property
        def collision_indices(self):
            if hasattr(self, '_m_collision_indices'):
                return self._m_collision_indices if hasattr(self, '_m_collision_indices') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_collision_indices)
                self._m_collision_indices = [None] * (self.num_collision_indices)
                for i in range(self.num_collision_indices):
                    self._m_collision_indices[i] = self._io.read_u2le()
        ...
        @property
        def collision_positions(self):
            if hasattr(self, '_m_collision_positions'):
                return self._m_collision_positions if hasattr(self, '_m_collision_positions') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_collision_positions)
                self._m_collision_positions = [None] * (self.num_collision_positions)
                for i in range(self.num_collision_positions):
                    self._m_collision_positions[i] = M2.C3vector(self._io, self, self._root)
        ...
        @property
        def sequences(self):
            if hasattr(self, '_m_sequences'):
                return self._m_sequences if hasattr(self, '_m_sequences') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_sequences)
                self._m_sequences = [None] * (self.num_sequences)
                for i in range(self.num_sequences):
                    self._m_sequences[i] = M2.M2sequence(self._io, self, self._root)
        ...
        def materials(self):
            if hasattr(self, '_m_materials'):
                return self._m_materials if hasattr(self, '_m_materials') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_materials)
                self._m_materials = [None] * (self.num_materials)
                for i in range(self.num_materials):
                    self._m_materials[i] = M2.M2material(self._io, self, self._root)
        ...
        def events(self):
            ...
            if True:
                ...
                self._m_events = [None] * (self.num_events)
                for i in range(self.num_events):
                    self._m_events[i] = M2.M2event(self._io, self, self._root)
        ...
        @property
        def texture_combiner_combos(self):
            if hasattr(self, '_m_texture_combiner_combos'):
                return self._m_texture_combiner_combos if hasattr(self, '_m_texture_combiner_combos') else None

            if self.flags.use_texture_combiner_combos:
                _pos = self._io.pos()
                self._io.seek(self.ofs_texture_combiner_combos)
                self._m_texture_combiner_combos = [None] * (self.num_texture_combiner_combos)
                for i in range(self.num_texture_combiner_combos):
                    self._m_texture_combiner_combos[i] = self._io.read_u2le()
        ...
        @property
        def uvanimlookup(self):
            if hasattr(self, '_m_uvanimlookup'):
                return self._m_uvanimlookup if hasattr(self, '_m_uvanimlookup') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_uvanimlookup)
                self._m_uvanimlookup = [None] * (self.num_uvanimlookup)
                for i in range(self.num_uvanimlookup):
                    self._m_uvanimlookup[i] = self._io.read_s2le()
        ...
        def attachments(self):
            if hasattr(self, '_m_attachments'):
                return self._m_attachments if hasattr(self, '_m_attachments') else None

            if True:
                _pos = self._io.pos()
                self._io.seek(self.ofs_attachments)
                self._m_attachments = [None] * (self.num_attachments)
                for i in range(self.num_attachments):
                    self._m_attachments[i] = M2.M2attachment(self._io, self, self._root)
    ...
    class ChunkTxac(KaitaiStruct):
        ...
        def _read(self):
            self.txac_mesh = [None] * (self._root.model.num_materials)
            for i in range(self._root.model.num_materials):
                self.txac_mesh[i] = self._io.read_u2le()

            self.txac_m_particle = [None] * (self._root.model.num_particle_emitters)
            for i in range(self._root.model.num_particle_emitters):
    ...
    class M2track(KaitaiStruct):
        ...
        def _read(self):
            self.interpolation_type = KaitaiStream.resolve_enum(M2.M2trackInterpolationTypes, self._io.read_u2le())
        ...
        def timestamps(self):
            ...
            if True:
                ...
                for i in range(self.num_timestamps):
                    self._m_timestamps[i] = M2.U4Nested(self._io, self, self._root)
    ...
    class ChunkTxid(KaitaiStruct):
        ...
        def _read(self):
            ...
            while not self._io.is_eof():
                self.file_data_ids.append(self._io.read_u4le())
                i += 1
    ...
    class Md20GlobalFlags(KaitaiStruct):
        ...
        def _read(self):
            self.tilt_x = self._io.read_bits_int_le(1) != 0
            self.tilt_y = self._io.read_bits_int_le(1) != 0
            self.unk_0x04 = self._io.read_bits_int_le(1) != 0
            self.use_texture_combiner_combos = self._io.read_bits_int_le(1) != 0
            self.unk_0x10 = self._io.read_bits_int_le(1) != 0
            self.load_phys_data = self._io.read_bits_int_le(1) != 0
            self.unk_0x40 = self._io.read_bits_int_le(1) != 0
            self.unk_0x80 = self._io.read_bits_int_le(1) != 0
            self.camera_related = self._io.read_bits_int_le(1) != 0
            self.new_particle_record = self._io.read_bits_int_le(1) != 0
            self.unk_0x400 = self._io.read_bits_int_le(1) != 0
            self.texture_transforms_use_bone_sequences = self._io.read_bits_int_le(1) != 0
            self.unk_0x1000 = self._io.read_bits_int_le(1) != 0
            self.unk_0x2000 = self._io.read_bits_int_le(1) != 0
            self.unk_0x4000 = self._io.read_bits_int_le(1) != 0
            self.unk_0x8000 = self._io.read_bits_int_le(1) != 0
            self.unk_0x10000 = self._io.read_bits_int_le(1) != 0
            self.unk_0x20000 = self._io.read_bits_int_le(1) != 0
            self.unk_0x40000 = self._io.read_bits_int_le(1) != 0
            self.unk_0x80000 = self._io.read_bits_int_le(1) != 0
            self.unk_0x100000 = self._io.read_bits_int_le(1) != 0
            self.unk_0x200000 = self._io.read_bits_int_le(1) != 0
            self.unused_0x400000 = self._io.read_bits_int_le(1) != 0
            self.unused_0x800000 = self._io.read_bits_int_le(1) != 0
            self.unused_0x01000000 = self._io.read_bits_int_le(1) != 0
            self.unused_0x02000000 = self._io.read_bits_int_le(1) != 0
            self.unused_0x04000000 = self._io.read_bits_int_le(1) != 0
            self.unused_0x08000000 = self._io.read_bits_int_le(1) != 0
            self.unused_0x10000000 = self._io.read_bits_int_le(1) != 0
            self.unused_0x20000000 = self._io.read_bits_int_le(1) != 0
            self.unused_0x40000000 = self._io.read_bits_int_le(1) != 0
            self.unused_0x80000000 = self._io.read_bits_int_le(1) != 0
    ...
    class AnimFileId(KaitaiStruct):
        ...
        def _read(self):
            self.anim_id = KaitaiStream.resolve_enum(M2.AnimNames, self._io.read_u2le())
            self.sub_anim_id = self._io.read_u2le()
            self.file_data_id = self._io.read_u4le()
    ...
    class ChunkSfid(KaitaiStruct):
        ...
        def _read(self):
            self.skin_file_data_ids = [None] * (self._root.model.num_skin_profiles)
            for i in range(self._root.model.num_skin_profiles):
    ...
    class ChunkExp2(KaitaiStruct):
        ...
        def _read(self):
            if True:
                self.num_content = self._io.read_u4le()

            if True:
                self.ofs_content = self._io.read_u4le()
        ...
        def content(self):
            ...
            if True:
                ...
                self._m_content = [None] * (self.num_content)
                for i in range(self.num_content):
                    self._m_content[i] = M2.M2extendedParticle(self._io, self, self._root)
