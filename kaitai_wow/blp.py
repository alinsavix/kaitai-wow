...
class Blp(KaitaiStruct):
    ...
    class M2sequence(KaitaiStruct):
        ...
        def _read(self):
            self.id = KaitaiStream.resolve_enum(Blp.AnimNames, self._io.read_u2le())
            ...
            self.flags = Blp.M2sequenceFlags(_io__raw_flags, self, self._root)
    ...
    class M2material(KaitaiStruct):
        ...
        def _read(self):
            ...
            _io__raw_flags = KaitaiStream(BytesIO(self._raw_flags))
            self.flags = Blp.M2materialFlags(_io__raw_flags, self, self._root)
    ...
    class M2texture(KaitaiStruct):
        ...
        def _read(self):
            self.type = KaitaiStream.resolve_enum(Blp.M2textureTypes, self._io.read_u4le())
            self._raw_flags = self._io.read_bytes(4)
            _io__raw_flags = KaitaiStream(BytesIO(self._raw_flags))
            self.flags = Blp.M2textureFlags(_io__raw_flags, self, self._root)
            if True:
    ...
    class M2compbone(KaitaiStruct):
        ...
        def _read(self):
            ...
            self._raw_flags = self._io.read_bytes(4)
            _io__raw_flags = KaitaiStream(BytesIO(self._raw_flags))
            self.flags = Blp.M2compboneFlags(_io__raw_flags, self, self._root)
    ...
    class M2track(KaitaiStruct):
        ...
        def _read(self):
            self.interpolation_type = KaitaiStream.resolve_enum(Blp.M2trackInterpolationTypes, self._io.read_u2le())
        ...
        def timestamps(self):
            ...
            if True:
                ...
                for i in range(self.num_timestamps):
                    self._m_timestamps[i] = Blp.U4Nested(self._io, self, self._root)
