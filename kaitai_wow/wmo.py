...
class Wmo(KaitaiStruct):
    ...
    class MomtShaders(Enum):
        ...
        env_metal = 5
        two_layer_diffuse = 6
        two_layer_env_metal = 7
        two_layer_terrain = 8
        diffuse_emissive = 9
        water_window = 10
        masked_env_metal = 11
        env_metal_emissive = 12
        two_layer_diffuse_opaque = 13
        submarine_window = 14
        two_layer_diffuse_emissive = 15
        diffuse_terrain = 16
        additive_masked_env_metal = 17
        two_layer_diffuse_mod_2x = 18
        two_layer_diffuse_mod2x_n_a = 19
        two_layer_diffuse_alpha = 20
        lod = 21
        parallax = 22

    class WmoLightTypes(Enum):
        omni = 0
        spot = 1
        direct = 2
        ambient = 3
    ...
    def _read(self):
        ...
        while not self._io.is_eof():
            self.chunks.append(Wmo.WmoChunk(self._io, self, self._root))
            i += 1
    ...
    class C3segment(KaitaiStruct):
        ...
        def _read(self):
            self.start = Wmo.C3vector(self._io, self, self._root)
            self.end = Wmo.C3vector(self._io, self, self._root)


    class ChunkModr(KaitaiStruct):
        """Map Object Doodad References.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MODR_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            ...
            i = 0
            while not self._io.is_eof():
                self.doodad_refs.append(self._io.read_u2le())
                i += 1



    class ChunkMolp(KaitaiStruct):
        """Map Object Point Lights.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MOLP_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            ...
            i = 0
            while not self._io.is_eof():
                self.map_object_point_lights.append(Wmo.PointLight(self._io, self, self._root))
                i += 1
    ...
    class M2light(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.position = Wmo.C3vector(self._io, self, self._root)
            self.ambient_color = Wmo.M2track(Wmo.M2trackTypes.c3vector, self._io, self, self._root)
            self.ambient_intensity = Wmo.M2track(Wmo.M2trackTypes.float, self._io, self, self._root)
            self.diffuse_color = Wmo.M2track(Wmo.M2trackTypes.c3vector, self._io, self, self._root)
            self.diffuse_intensity = Wmo.M2track(Wmo.M2trackTypes.float, self._io, self, self._root)
            self.attenuation_start = Wmo.M2track(Wmo.M2trackTypes.float, self._io, self, self._root)
            self.attenuation_end = Wmo.M2track(Wmo.M2trackTypes.float, self._io, self, self._root)
            self.visibility = Wmo.M2track(Wmo.M2trackTypes.uint8, self._io, self, self._root)
    ...
    class M2extendedParticle(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.unknown3 = Wmo.M2parttrack(Wmo.M2arrayTypes.fixed16, self._io, self, self._root)


    class ChunkMovi(KaitaiStruct):
        """Map Object Vertex Indices - Group's vertex indices from the group's vertex list (MOVT, MONR, MOTV) to form triangles.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MOVI_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
    ...
    class ChunkMogn(KaitaiStruct):
        """Map Object Group Names.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MOGN_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            ...
            i = 0
            while not self._io.is_eof():
                self.group_names.append((self._io.read_bytes_term(0, False, True, True)).decode(u"UTF-8"))
                i += 1
    ...
    class M2sequence(KaitaiStruct):
        ...
        def _read(self):
            self.id = KaitaiStream.resolve_enum(Wmo.AnimNames, self._io.read_u2le())
            ...
            self.flags = Wmo.M2sequenceFlags(_io__raw_flags, self, self._root)
            self.frequency = self._io.read_s2le()
            self.padding = self._io.read_u2le()
            self.replay = Wmo.M2range(self._io, self, self._root)
            self.blend_time_in = self._io.read_u2le()
            self.blend_time_out = self._io.read_u2le()
            self.bounds = Wmo.M2bounds(self._io, self, self._root)
    ...
    class M2texturetransform(KaitaiStruct):
        ...
        def _read(self):
            self.translation = Wmo.M2track(Wmo.M2trackTypes.c3vector, self._io, self, self._root)
            self.rotation = Wmo.M2track(Wmo.M2trackTypes.c4quaternion, self._io, self, self._root)
            self.scaling = Wmo.M2track(Wmo.M2trackTypes.c3vector, self._io, self, self._root)
    ...
    class M2particleOld(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.flags = Wmo.M2particlesFlags(self._io, self, self._root)
            self.position = Wmo.C3vector(self._io, self, self._root)
            ...
            self.blending_type = KaitaiStream.resolve_enum(Wmo.Blendmodes, self._io.read_u1())
            self.emitter_type = KaitaiStream.resolve_enum(Wmo.EmitterTypes, self._io.read_u1())
            ...
            self.emission_speed = Wmo.M2track(Wmo.M2trackTypes.float, self._io, self, self._root)
            self.speed_variation = Wmo.M2track(Wmo.M2trackTypes.float, self._io, self, self._root)
            self.vertical_range = Wmo.M2track(Wmo.M2trackTypes.float, self._io, self, self._root)
            self.horizontal_range = Wmo.M2track(Wmo.M2trackTypes.float, self._io, self, self._root)
            self.gravity = Wmo.M2track(Wmo.M2trackTypes.float, self._io, self, self._root)
            self.lifespan = Wmo.M2track(Wmo.M2trackTypes.float, self._io, self, self._root)
            self.lifespan_vary = self._io.read_f4le()
            self.emission_rate = Wmo.M2track(Wmo.M2trackTypes.float, self._io, self, self._root)
            self.emission_rate_vary = self._io.read_f4le()
            self.emission_area_length = Wmo.M2track(Wmo.M2trackTypes.float, self._io, self, self._root)
            self.emission_area_width = Wmo.M2track(Wmo.M2trackTypes.float, self._io, self, self._root)
            self.z_source = Wmo.M2track(Wmo.M2trackTypes.float, self._io, self, self._root)
            self.p = Wmo.ModelParticleParams(self._io, self, self._root)
            self.enabled_in = Wmo.M2track(Wmo.M2trackTypes.uint16, self._io, self, self._root)
    ...
    class Cfacet(KaitaiStruct):
        ...
        def _read(self):
            self.plane = Wmo.C4plane(self._io, self, self._root)
            self.vertices = [None] * (3)
            for i in range(3):
                self.vertices[i] = Wmo.C3vector(self._io, self, self._root)
    ...
    class M2array(KaitaiStruct):
        ...
        def values(self):
            ...
            for i in range(self.num):
                ...
                if _on == Wmo.M2arrayTypes.fixed16:
                    self._m_values[i] = Wmo.Fixed16(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2ribbon:
                    self._m_values[i] = Wmo.M2ribbon(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.int16:
                    self._m_values[i] = self._io.read_s2le()
                elif _on == Wmo.M2arrayTypes.m2array_c4quaternion:
                    self._m_values[i] = Wmo.M2array(Wmo.M2arrayTypes.c4quaternion, self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2vertex:
                    self._m_values[i] = Wmo.M2vertex(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2light:
                    self._m_values[i] = Wmo.M2light(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2sequence:
                    self._m_values[i] = Wmo.M2sequence(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2array_fixed16:
                    self._m_values[i] = Wmo.M2array(Wmo.M2arrayTypes.fixed16, self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2array_c3vector:
                    self._m_values[i] = Wmo.M2array(Wmo.M2arrayTypes.c3vector, self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2loop:
                    self._m_values[i] = Wmo.M2loop(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2sequencefallback:
                    self._m_values[i] = Wmo.M2sequencefallback(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.uint8:
                    self._m_values[i] = self._io.read_u1()
                elif _on == Wmo.M2arrayTypes.uint32:
                    self._m_values[i] = self._io.read_u4le()
                elif _on == Wmo.M2arrayTypes.todo:
                    self._m_values[i] = Wmo.M2arrayTodo(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2event:
                    self._m_values[i] = Wmo.M2event(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.c4quaternion:
                    self._m_values[i] = Wmo.C4quaternion(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2texturetransform:
                    self._m_values[i] = Wmo.M2texturetransform(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.c3vector:
                    self._m_values[i] = Wmo.C3vector(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2particle:
                    self._m_values[i] = Wmo.M2particle(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2color:
                    self._m_values[i] = Wmo.M2color(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2shadowbatch:
                    self._m_values[i] = Wmo.M2shadowbatch(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.float:
                    self._m_values[i] = self._io.read_f4le()
                elif _on == Wmo.M2arrayTypes.c4vector:
                    self._m_values[i] = Wmo.C4vector(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2texture:
                    self._m_values[i] = Wmo.M2texture(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.c2vector:
                    self._m_values[i] = Wmo.C2vector(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2array_c4vector:
                    self._m_values[i] = Wmo.M2array(Wmo.M2arrayTypes.c4vector, self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2extended_particle:
                    self._m_values[i] = Wmo.M2extendedParticle(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.uint16:
                    self._m_values[i] = self._io.read_u2le()
                elif _on == Wmo.M2arrayTypes.m2array_m2compquat:
                    self._m_values[i] = Wmo.M2array(Wmo.M2arrayTypes.m2compquat, self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2attachment:
                    self._m_values[i] = Wmo.M2attachment(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.int8:
                    self._m_values[i] = self._io.read_s1()
                elif _on == Wmo.M2arrayTypes.m2array_float:
                    self._m_values[i] = Wmo.M2array(Wmo.M2arrayTypes.float, self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2array_c2vector:
                    self._m_values[i] = Wmo.M2array(Wmo.M2arrayTypes.c2vector, self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.frgb:
                    self._m_values[i] = Wmo.Frgb(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2material:
                    self._m_values[i] = Wmo.M2material(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2array_uint32:
                    self._m_values[i] = Wmo.M2array(Wmo.M2arrayTypes.uint32, self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2compquat:
                    self._m_values[i] = Wmo.M2compquat(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.ubyte4:
                    self._m_values[i] = Wmo.Ubyte4(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2camera:
                    self._m_values[i] = Wmo.M2camera(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2compbone:
                    self._m_values[i] = Wmo.M2compbone(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.pgd1_entry:
                    self._m_values[i] = Wmo.Pgd1Entry(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2array_uint16:
                    self._m_values[i] = Wmo.M2array(Wmo.M2arrayTypes.uint16, self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2batch:
                    self._m_values[i] = Wmo.M2batch(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2skinsection:
                    self._m_values[i] = Wmo.M2skinsection(self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2array_uint8:
                    self._m_values[i] = Wmo.M2array(Wmo.M2arrayTypes.uint8, self._io, self, self._root)
                elif _on == Wmo.M2arrayTypes.m2textureweight:
                    self._m_values[i] = Wmo.M2textureweight(self._io, self, self._root)

            self._io.seek(_pos)
            return self._m_values if hasattr(self, '_m_values') else None


    class ChunkMovv(KaitaiStruct):
        """Map Object Visible Block Vertices.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MOVV_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            self.visible_block_vertices = []
            i = 0
            while not self._io.is_eof():
                self.visible_block_vertices.append(Wmo.C3vector(self._io, self, self._root))
                i += 1
    ...
    class M2textureweight(KaitaiStruct):
        ...
        def _read(self):
            self.weight = Wmo.M2track(Wmo.M2trackTypes.fixed16, self._io, self, self._root)
    ...
    class M2bounds(KaitaiStruct):
        ...
        def _read(self):
            self.extent = Wmo.Caabox(self._io, self, self._root)
    ...
    class M2camera(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.positions = Wmo.M2track(Wmo.M2trackTypes.todo, self._io, self, self._root)
            self.position_base = Wmo.C3vector(self._io, self, self._root)
            self.target_position = Wmo.M2track(Wmo.M2trackTypes.todo, self._io, self, self._root)
            self.target_position_base = Wmo.C3vector(self._io, self, self._root)
            self.roll = Wmo.M2track(Wmo.M2trackTypes.todo, self._io, self, self._root)
            self.fov = Wmo.M2track(Wmo.M2trackTypes.todo, self._io, self, self._root)


    class ChunkMosb(KaitaiStruct):
        """Map Object Sky Box - zero terminated skybox. If first byte is 0, skybox flag in all MOGI entries are cleared and there is no skybox.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MOSB_chunk_.28optional.29.E1.B5.98
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            self.skybox_name = (self._io.read_bytes_term(0, False, True, True)).decode(u"UTF-8")
    ...
    class ChunkMonr(KaitaiStruct):
        """Map Object Normals.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MONR_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            ...
            i = 0
            while not self._io.is_eof():
                self.normals.append(Wmo.C3vector(self._io, self, self._root))
                i += 1
    ...
    class C34matrix(KaitaiStruct):
        ...
        def _read(self):
            self.columns = [None] * (4)
            for i in range(4):
                self.columns[i] = Wmo.C3vector(self._io, self, self._root)



    class FogInfoFlags(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            self.infinite_radius = self._io.read_bits_int_le(1) != 0
            self.unused1 = self._io.read_bits_int_le(3)
            self.unk_0x10 = self._io.read_bits_int_le(1) != 0
            self.unused2 = self._io.read_bits_int_le(27)
    ...
    class C3ray(KaitaiStruct):
        ...
        def _read(self):
            self.origin = Wmo.C3vector(self._io, self, self._root)
            self.dir = Wmo.C3vector(self._io, self, self._root)


    class ChunkMopv(KaitaiStruct):
        """Map Object Portal Vertex List.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MOPV_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            self.portal_vertexes = []
            i = 0
            while not self._io.is_eof():
                self.portal_vertexes.append(Wmo.C3vector(self._io, self, self._root))
                i += 1
    ...
    class MogpGroupFlags(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            self.has_bsp_tree = self._io.read_bits_int_le(1) != 0
            self.has_light_map = self._io.read_bits_int_le(1) != 0
            self.has_vertex_colors = self._io.read_bits_int_le(1) != 0
            self.smogroup_exterior = self._io.read_bits_int_le(1) != 0
            self.unused1 = self._io.read_bits_int_le(1) != 0
            self.unused2 = self._io.read_bits_int_le(1) != 0
            self.smogroup_exterior_lit = self._io.read_bits_int_le(1) != 0
            self.smogroup_unreachable = self._io.read_bits_int_le(1) != 0
            self.show_exterior_sky = self._io.read_bits_int_le(1) != 0
            self.has_lights = self._io.read_bits_int_le(1) != 0
            self.unknown_shadow = self._io.read_bits_int_le(1) != 0
            self.has_doodads = self._io.read_bits_int_le(1) != 0
            self.smogroup_liquidsurface = self._io.read_bits_int_le(1) != 0
            self.smogroup_interior = self._io.read_bits_int_le(1) != 0
            self.unused3 = self._io.read_bits_int_le(1) != 0
            self.query_mount_allowed = self._io.read_bits_int_le(1) != 0
            self.smogroup_alwaysdraw = self._io.read_bits_int_le(1) != 0
            self.unused4 = self._io.read_bits_int_le(1) != 0
            self.show_skybox = self._io.read_bits_int_le(1) != 0
            self.water_is_ocean = self._io.read_bits_int_le(1) != 0
            self.unknown1 = self._io.read_bits_int_le(1) != 0
            self.is_mount_allowed = self._io.read_bits_int_le(1) != 0
            self.unused5 = self._io.read_bits_int_le(1) != 0
            self.unknown2 = self._io.read_bits_int_le(1) != 0
            self.smogroup_cverts2 = self._io.read_bits_int_le(1) != 0
            self.smogroup_tverts2 = self._io.read_bits_int_le(1) != 0
            self.smogroup_antiportal = self._io.read_bits_int_le(1) != 0
            self.unknown3 = self._io.read_bits_int_le(1) != 0
            self.unused6 = self._io.read_bits_int_le(1) != 0
            self.smogroup_exterior_cull = self._io.read_bits_int_le(1) != 0
            self.smogroup_tverts3 = self._io.read_bits_int_le(1) != 0
    ...
    class C4plane(KaitaiStruct):
        ...
        def _read(self):
            self.normal = Wmo.C3vector(self._io, self, self._root)
            self.distance = self._io.read_f4le()


    class LightList(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            self.type = KaitaiStream.resolve_enum(Wmo.WmoLightTypes, self._io.read_u1())
            self.use_attenuation = self._io.read_u1()
            self.unknown1 = self._io.read_u2le()
            self.color = Wmo.Cimvector(self._io, self, self._root)
            self.position = Wmo.C3vector(self._io, self, self._root)
            ...
            self.attenuation_start = self._io.read_f4le()
            self.attenuation_end = self._io.read_f4le()
    ...
    class MliqVertex(KaitaiStruct):
        ...
        def _read(self):
            self.flow1 = self._io.read_u1()
            self.flow2 = self._io.read_u1()
            self.flow1pct = self._io.read_u1()
    ...
    class M2material(KaitaiStruct):
        ...
        def _read(self):
            ...
            _io__raw_flags = KaitaiStream(BytesIO(self._raw_flags))
            self.flags = Wmo.M2materialFlags(_io__raw_flags, self, self._root)
            self.blending_mode = KaitaiStream.resolve_enum(Wmo.M2materialBlendmodes, self._io.read_u2le())
    ...
    class M2color(KaitaiStruct):
        ...
        def _read(self):
            self.color = Wmo.M2track(Wmo.M2trackTypes.c3vector, self._io, self, self._root)
            self.alpha = Wmo.M2track(Wmo.M2trackTypes.fixed16, self._io, self, self._root)
    ...
    class ModelParticleParams(KaitaiStruct):
        ...
        def _read(self):
            self.colors = Wmo.Fblock(Wmo.M2arrayTypes.frgb, self._io, self, self._root)
            self.opacity = Wmo.Fblock(Wmo.M2arrayTypes.uint16, self._io, self, self._root)
            self.sizes = Wmo.Fblock(Wmo.M2arrayTypes.c2vector, self._io, self, self._root)
            self.d = [None] * (2)
            for i in range(2):
                self.d[i] = self._io.read_u4le()

            self.intensity = Wmo.Fblock(Wmo.M2arrayTypes.uint16, self._io, self, self._root)
            self.unk2 = Wmo.Fblock(Wmo.M2arrayTypes.uint16, self._io, self, self._root)
            self.unk = [None] * (3)
            for i in range(3):
                self.unk[i] = self._io.read_f4le()

            self.scales = Wmo.C3vector(self._io, self, self._root)
            ...
            self.rot1 = Wmo.C3vector(self._io, self, self._root)
            self.rot2 = Wmo.C3vector(self._io, self, self._root)
            self.trans = Wmo.C3vector(self._io, self, self._root)
            self.f2 = [None] * (4)
            for i in range(4):
                self.f2[i] = self._io.read_f4le()

            self.unknown_reference = Wmo.M2array(Wmo.M2arrayTypes.todo, self._io, self, self._root)
    ...
    class M2event(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.position = Wmo.C3vector(self._io, self, self._root)
            self.enabled = Wmo.M2trackbase(self._io, self, self._root)
    ...
    class PortalInfo(KaitaiStruct):
        ...
        def _read(self):
            self.start_vertex = self._io.read_u2le()
    ...
    class M2texture(KaitaiStruct):
        ...
        def _read(self):
            self.type = KaitaiStream.resolve_enum(Wmo.M2textureTypes, self._io.read_u4le())
            self._raw_flags = self._io.read_bytes(4)
            _io__raw_flags = KaitaiStream(BytesIO(self._raw_flags))
            self.flags = Wmo.M2textureFlags(_io__raw_flags, self, self._root)
            if True:
    ...
    class ChunkMohd(KaitaiStruct):
        """Map Object Header.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MOHD_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            ...
            self.num_portals = self._io.read_u4le()
            self.num_lights = self._io.read_u4le()
            self.num_doodad_names = self._io.read_u4le()
            self.num_doodad_defs = self._io.read_u4le()
            self.num_doodad_sets = self._io.read_u4le()
            self.amb_color = Wmo.Cargb(self._io, self, self._root)
            self.foreign_key = self._io.read_u4le()
            self.bounding_box = Wmo.Caabox(self._io, self, self._root)
            self.flags = Wmo.MohdFlags(self._io, self, self._root)
            self.num_lod = self._io.read_u2le()
    ...
    class M2compbone(KaitaiStruct):
        ...
        def _read(self):
            ...
            self._raw_flags = self._io.read_bytes(4)
            _io__raw_flags = KaitaiStream(BytesIO(self._raw_flags))
            self.flags = Wmo.M2compboneFlags(_io__raw_flags, self, self._root)
            self.parent_bone = self._io.read_s2le()
            self.submesh_id = self._io.read_u2le()
            self.bone_name_crc = self._io.read_u4le()
            self.translation = Wmo.M2track(Wmo.M2trackTypes.c3vector, self._io, self, self._root)
            self.rotation = Wmo.M2track(Wmo.M2trackTypes.m2compquat, self._io, self, self._root)
            self.scale = Wmo.M2track(Wmo.M2trackTypes.c3vector, self._io, self, self._root)
            self.pivot = Wmo.C3vector(self._io, self, self._root)
    ...
    class ChunkMdal(KaitaiStruct):
        """
        .. seealso::
           Source - https://wowdev.wiki/WMO#MDAL_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            self.header_color_replacement = Wmo.Cargb(self._io, self, self._root)


    class ChunkMogp(KaitaiStruct):
        """Map Object Group Definition.
        ...
        def _read(self):
            self.group_name = self._io.read_u4le()
            self.descriptive_group_name = self._io.read_u4le()
            self.flags = Wmo.MogpGroupFlags(self._io, self, self._root)
            self.bounding_box = Wmo.Caabox(self._io, self, self._root)
            self.portal_start = self._io.read_u2le()
            self.portal_count = self._io.read_u2le()
            self.trans_batch_count = self._io.read_u2le()
            self.int_batch_count = self._io.read_u2le()
            self.ext_batch_count = self._io.read_u2le()
            self.unknown1 = self._io.read_u2le()
            self.fog_ids = [None] * (4)
            for i in range(4):
                self.fog_ids[i] = self._io.read_u1()

            self.group_liquid = self._io.read_u4le()
            self.foreign_key = self._io.read_u4le()
            ...
            i = 0
            while True:
                _ = Wmo.WmoChunk(self._io, self, self._root)
    ...
    class M2vertex(KaitaiStruct):
        ...
        def _read(self):
            self.pos = Wmo.C3vector(self._io, self, self._root)
            ...
            for i in range(2):
                self.tex_coords[i] = Wmo.C2vector(self._io, self, self._root)



    class PointLight(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            ...
            self.attenuation_start = self._io.read_f4le()
            self.attenuation_end = self._io.read_f4le()
            self.unknown4 = self._io.read_f4le()
            self.unknown5 = self._io.read_u4le()
            self.unknown6 = self._io.read_u4le()


    class PortalReferenceList(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            self.portal_index = self._io.read_u2le()
            self.group_index = self._io.read_u2le()
            self.side = self._io.read_s2le()
            self.unused1 = self._io.read_u2le()


    class GroupInfoList(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            self.flags = Wmo.MogpGroupFlags(self._io, self, self._root)
            self.bounding_box = Wmo.Caabox(self._io, self, self._root)
            self.name_offset = self._io.read_s4le()
    ...
    class ChunkMolt(KaitaiStruct):
        """Map Object Lighting Information.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MOLT_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            ...
            i = 0
            while not self._io.is_eof():
                self.lights.append(Wmo.LightList(self._io, self, self._root))
                i += 1



    class ChunkMogi(KaitaiStruct):
        """Map Object Group Information.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MOGI_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            ...
            i = 0
            while not self._io.is_eof():
                self.group_info.append(Wmo.GroupInfoList(self._io, self, self._root))
                i += 1
    ...
    class ShadowBatchList(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            self.unknown1 = [None] * (10)
            for i in range(10):
                self.unknown1[i] = self._io.read_u1()

            self.material_id_big = self._io.read_u2le()
            self.field2 = self._io.read_u4le()
            self.field6 = self._io.read_u2le()
            self.unknown2 = [None] * (4)
            for i in range(4):
                self.unknown2[i] = self._io.read_u1()

            self.flag_thing = self._io.read_u1()
            self.material_id_small = self._io.read_u1()


    class MohdFlags(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            self.no_attenuate_portal_dist = self._io.read_bits_int_le(1) != 0
            self.unified_render_path = self._io.read_bits_int_le(1) != 0
            self.liquid_type_from_dbc = self._io.read_bits_int_le(1) != 0
            self.no_fix_vertex_color_alpha = self._io.read_bits_int_le(1) != 0
            self.lod = self._io.read_bits_int_le(1) != 0
            self.default_max_lod = self._io.read_bits_int_le(1) != 0
            self.unused1 = self._io.read_bits_int_le(10)
    ...
    class ChunkMobs(KaitaiStruct):
        """Map Object Shadow Batches.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MOBS_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            ...
            i = 0
            while not self._io.is_eof():
                self.shadow_batches.append(Wmo.ShadowBatchList(self._io, self, self._root))
                i += 1
    ...
    class ChunkMoba(KaitaiStruct):
        """Map Object Render Batches.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MOBA_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            ...
            i = 0
            while not self._io.is_eof():
                self.batches.append(Wmo.BatchList(self._io, self, self._root))
                i += 1



    class ChunkMfog(KaitaiStruct):
        """Map Object Fog Information.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MFOG_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            ...
            i = 0
            while not self._io.is_eof():
                self.fogs.append(Wmo.FogsInfo(self._io, self, self._root))
                i += 1



    class ChunkMobr(KaitaiStruct):
        """Map Object Node Face Indexes.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MOBR_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            self.node_face_indices = []
            i = 0
            while not self._io.is_eof():
                self.node_face_indices.append(self._io.read_u2le())
                i += 1
    ...
    class M2track(KaitaiStruct):
        ...
        def _read(self):
            self.interpolation_type = KaitaiStream.resolve_enum(Wmo.M2trackInterpolationTypes, self._io.read_u2le())
            ...
            if _on == Wmo.M2trackTypes.uint8:
                self.values = Wmo.M2array(Wmo.M2arrayTypes.m2array_uint8, self._io, self, self._root)
            elif _on == Wmo.M2trackTypes.c2vector:
                self.values = Wmo.M2array(Wmo.M2arrayTypes.m2array_c2vector, self._io, self, self._root)
            elif _on == Wmo.M2trackTypes.c4quaternion:
                self.values = Wmo.M2array(Wmo.M2arrayTypes.m2array_c4quaternion, self._io, self, self._root)
            elif _on == Wmo.M2trackTypes.m2compquat:
                self.values = Wmo.M2array(Wmo.M2arrayTypes.m2array_m2compquat, self._io, self, self._root)
            elif _on == Wmo.M2trackTypes.uint16:
                self.values = Wmo.M2array(Wmo.M2arrayTypes.m2array_uint16, self._io, self, self._root)
            elif _on == Wmo.M2trackTypes.float:
                self.values = Wmo.M2array(Wmo.M2arrayTypes.m2array_float, self._io, self, self._root)
            elif _on == Wmo.M2trackTypes.fixed16:
                self.values = Wmo.M2array(Wmo.M2arrayTypes.m2array_fixed16, self._io, self, self._root)
            elif _on == Wmo.M2trackTypes.todo:
                self.values = Wmo.M2array(Wmo.M2arrayTypes.todo, self._io, self, self._root)
            elif _on == Wmo.M2trackTypes.c3vector:
                self.values = Wmo.M2array(Wmo.M2arrayTypes.m2array_c3vector, self._io, self, self._root)
        ...
        def timestamps(self):
            ...
            if True:
                ...
                for i in range(self.num_timestamps):
                    self._m_timestamps[i] = Wmo.U4Nested(self._io, self, self._root)
    ...
    class ChunkMotv(KaitaiStruct):
        """Map Object Texture Vertexes/Coordinates.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MOTV_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            ...
            i = 0
            while not self._io.is_eof():
                self.tex_coords.append(Wmo.C2vector(self._io, self, self._root))
                i += 1



    class ChunkMota(KaitaiStruct):
        """Map Object Tangent Array.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MOTA
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
    ...
    class BatchListFlags(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            self.unknown1 = self._io.read_bits_int_le(1) != 0
            self.use_material_id_large = self._io.read_bits_int_le(1) != 0
            self.unused1 = self._io.read_bits_int_le(6)
    ...
    class WmoChunk(KaitaiStruct):
        ...
        def _read(self):
            ...
            if _on == u"MONR":
                ...
                self.chunk_data = Wmo.ChunkMonr(_io__raw_chunk_data, self, self._root)
            elif _on == u"MOTA":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMota(_io__raw_chunk_data, self, self._root)
            elif _on == u"MOBA":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMoba(_io__raw_chunk_data, self, self._root)
            elif _on == u"MOVI":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMovi(_io__raw_chunk_data, self, self._root)
            elif _on == u"MOBN":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMobn(_io__raw_chunk_data, self, self._root)
            elif _on == u"MOGI":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMogi(_io__raw_chunk_data, self, self._root)
            elif _on == u"MODS":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMods(_io__raw_chunk_data, self, self._root)
            elif _on == u"MOGN":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMogn(_io__raw_chunk_data, self, self._root)
            elif _on == u"MOLP":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMolp(_io__raw_chunk_data, self, self._root)
            elif _on == u"GFID":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkGfid(_io__raw_chunk_data, self, self._root)
            elif _on == u"MOVT":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMovt(_io__raw_chunk_data, self, self._root)
            elif _on == u"MOBR":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMobr(_io__raw_chunk_data, self, self._root)
            elif _on == u"MOSB":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMosb(_io__raw_chunk_data, self, self._root)
            elif _on == u"MODI":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkModi(_io__raw_chunk_data, self, self._root)
            elif _on == u"MOPV":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMopv(_io__raw_chunk_data, self, self._root)
            elif _on == u"MOTV":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMotv(_io__raw_chunk_data, self, self._root)
            elif _on == u"MOCV":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMocv(_io__raw_chunk_data, self, self._root)
            elif _on == u"MOPR":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMopr(_io__raw_chunk_data, self, self._root)
            elif _on == u"MOHD":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMohd(_io__raw_chunk_data, self, self._root)
            elif _on == u"MOBS":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMobs(_io__raw_chunk_data, self, self._root)
            elif _on == u"MOVV":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMovv(_io__raw_chunk_data, self, self._root)
            elif _on == u"MODR":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkModr(_io__raw_chunk_data, self, self._root)
            elif _on == u"MFOG":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMfog(_io__raw_chunk_data, self, self._root)
            elif _on == u"MOPT":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMopt(_io__raw_chunk_data, self, self._root)
            elif _on == u"MLIQ":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMliq(_io__raw_chunk_data, self, self._root)
            elif _on == u"MOGP":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMogp(_io__raw_chunk_data, self, self._root)
            elif _on == u"MOMT":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMomt(_io__raw_chunk_data, self, self._root)
            elif _on == u"MDAL":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMdal(_io__raw_chunk_data, self, self._root)
            elif _on == u"MOLT":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMolt(_io__raw_chunk_data, self, self._root)
            elif _on == u"MODD":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkModd(_io__raw_chunk_data, self, self._root)
            elif _on == u"MOPY":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.ChunkMopy(_io__raw_chunk_data, self, self._root)
            else:
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Wmo.UnknownChunk(_io__raw_chunk_data, self, self._root)
    ...
    class M2parttrack(KaitaiStruct):
        ...
        def _read(self):
            self.times = Wmo.M2array(Wmo.M2arrayTypes.fixed16, self._io, self, self._root)
            _on = self.m2array_type
            if _on == Wmo.M2arrayTypes.fixed16:
                self.values = Wmo.M2array(Wmo.M2arrayTypes.fixed16, self._io, self, self._root)
    ...
    class Vector2fp69(KaitaiStruct):
        ...
        def _read(self):
            self.x = Wmo.Fp69(self._io, self, self._root)
            self.y = Wmo.Fp69(self._io, self, self._root)


    class FogInfo(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            self.end = self._io.read_f4le()
            self.start_scalar = self._io.read_f4le()
            self.color = Wmo.Cimvector(self._io, self, self._root)


    class ChunkModi(KaitaiStruct):
        """Map Object Doodad File IDs.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MODI_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            self.doodad_file_data_ids = []
            i = 0
            while not self._io.is_eof():
                self.doodad_file_data_ids.append(self._io.read_u4le())
                i += 1



    class ChunkMovt(KaitaiStruct):
        """Map Object Vertices.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MOVT_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            ...
            i = 0
            while not self._io.is_eof():
                self.vertices.append(Wmo.C3vector(self._io, self, self._root))
                i += 1
    ...
    class PolyList(KaitaiStruct):
        ...
        def _read(self):
            self.flags = Wmo.PolyListFlags(self._io, self, self._root)
            self.material_id = self._io.read_u1()
    ...
    class ChunkMocv(KaitaiStruct):
        """Map Object Vertex Colors.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MOCV_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            ...
            i = 0
            while not self._io.is_eof():
                self.vertex_colors.append(Wmo.Cimvector(self._io, self, self._root))
                i += 1



    class DoodadSetList(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            self.name = (KaitaiStream.bytes_terminate(self._io.read_bytes(20), 0, False)).decode(u"UTF-8")
            self.start_index = self._io.read_u4le()
            self.count = self._io.read_u4le()
            self.unused1 = self._io.read_u4le()


    class ChunkMliq(KaitaiStruct):
        """Map Liquid Information.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MLIQ_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            self.liquid_verts = Wmo.C2ivector(self._io, self, self._root)
            self.liquid_tiles = Wmo.C2ivector(self._io, self, self._root)
            self.lquid_corner = Wmo.C3vector(self._io, self, self._root)
            self.liquid_material_id = self._io.read_u2le()
            self.vertex_list = [None] * ((self.liquid_verts.x * self.liquid_verts.y))
            for i in range((self.liquid_verts.x * self.liquid_verts.y)):
                self.vertex_list[i] = Wmo.MliqVertex(self._io, self, self._root)

            self.tile_list = [None] * ((self.liquid_tiles.x * self.liquid_tiles.y))
            for i in range((self.liquid_tiles.x * self.liquid_tiles.y)):
                self.tile_list[i] = Wmo.MliqTile(self._io, self, self._root)



    class MaterialList(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            self.flags = Wmo.MomtFlags(self._io, self, self._root)
            self.shader_id = KaitaiStream.resolve_enum(Wmo.MomtShaders, self._io.read_u4le())
            self.blend_mode = self._io.read_u4le()
            self.texture1_file_data_id = self._io.read_u4le()
            self.sidn_color = Wmo.Cimvector(self._io, self, self._root)
            self.frame_sidn_color = Wmo.Cimvector(self._io, self, self._root)
            self.texture2_file_data_id = self._io.read_u4le()
            self.diff_color = Wmo.Cargb(self._io, self, self._root)
            self.foreign_key = self._io.read_u4le()
            self.texture3_file_data_id = self._io.read_u4le()
            self.color2 = self._io.read_u4le()
            self.flags2 = self._io.read_u4le()
            self.runtime_data = [None] * (4)
            for i in range(4):
                self.runtime_data[i] = self._io.read_u4le()



    class ChunkMomt(KaitaiStruct):
        """Map Object Materials.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MOMT_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            ...
            i = 0
            while not self._io.is_eof():
                self.materials.append(Wmo.MaterialList(self._io, self, self._root))
                i += 1
    ...
    class M2trackbase(KaitaiStruct):
        ...
        def _read(self):
            self.interpolation_type = KaitaiStream.resolve_enum(Wmo.M2trackInterpolationTypes, self._io.read_u2le())
            self.global_sequence = self._io.read_s2le()
            self.timestamps = Wmo.M2array(Wmo.M2arrayTypes.m2array_uint32, self._io, self, self._root)
    ...
    class M2particle(KaitaiStruct):
        ...
        def _read(self):
            self.old = Wmo.M2particleOld(self._io, self, self._root)
            self.multi_texture_param0 = [None] * (2)
            for i in range(2):
                self.multi_texture_param0[i] = Wmo.Vector2fp69(self._io, self, self._root)

            self.multi_texture_param1 = [None] * (2)
            for i in range(2):
                self.multi_texture_param1[i] = Wmo.Vector2fp69(self._io, self, self._root)



    class MomtFlags(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            ...
            self.unculled = self._io.read_bits_int_le(1) != 0
            self.extlight = self._io.read_bits_int_le(1) != 0
            self.sidn = self._io.read_bits_int_le(1) != 0
            self.window = self._io.read_bits_int_le(1) != 0
            self.clamp_s = self._io.read_bits_int_le(1) != 0
            self.clamp_t = self._io.read_bits_int_le(1) != 0
            self.flag_0x100 = self._io.read_bits_int_le(1) != 0
            self.unused1 = self._io.read_bits_int_le(23)


    class MliqTile(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            self.liquid = self._io.read_bits_int_le(6)
            self.fishable = self._io.read_bits_int_le(1) != 0
            self.shared = self._io.read_bits_int_le(1) != 0
    ...
    class Bspnode(KaitaiStruct):
        ...
        def _read(self):
            self.flags = KaitaiStream.resolve_enum(Wmo.BspnodeFlags, self._io.read_u2le())
            self.neg_child = self._io.read_s2le()
            self.pos_child = self._io.read_s2le()
            self.num_faces = self._io.read_u2le()
            self.face_start = self._io.read_u4le()
            self.plane_dist = self._io.read_f4le()
    ...
    class Fblock(KaitaiStruct):
        ...
        def _read(self):
            self.timestamps = Wmo.M2array(Wmo.M2arrayTypes.uint16, self._io, self, self._root)
            _on = self.m2array_type
            if _on == Wmo.M2arrayTypes.fixed16:
                self.values = Wmo.M2array(Wmo.M2arrayTypes.fixed16, self._io, self, self._root)
            elif _on == Wmo.M2arrayTypes.uint8:
                self.values = Wmo.M2array(Wmo.M2arrayTypes.uint8, self._io, self, self._root)
            elif _on == Wmo.M2arrayTypes.todo:
                self.values = Wmo.M2array(Wmo.M2arrayTypes.todo, self._io, self, self._root)
            elif _on == Wmo.M2arrayTypes.c4quaternion:
                self.values = Wmo.M2array(Wmo.M2arrayTypes.c4quaternion, self._io, self, self._root)
            elif _on == Wmo.M2arrayTypes.c3vector:
                self.values = Wmo.M2array(Wmo.M2arrayTypes.c3vector, self._io, self, self._root)
            elif _on == Wmo.M2arrayTypes.float:
                self.values = Wmo.M2array(Wmo.M2arrayTypes.float, self._io, self, self._root)
            elif _on == Wmo.M2arrayTypes.c4vector:
                self.values = Wmo.M2array(Wmo.M2arrayTypes.c4vector, self._io, self, self._root)
            elif _on == Wmo.M2arrayTypes.c2vector:
                self.values = Wmo.M2array(Wmo.M2arrayTypes.c2vector, self._io, self, self._root)
            elif _on == Wmo.M2arrayTypes.uint16:
                self.values = Wmo.M2array(Wmo.M2arrayTypes.uint16, self._io, self, self._root)
            elif _on == Wmo.M2arrayTypes.frgb:
                self.values = Wmo.M2array(Wmo.M2arrayTypes.frgb, self._io, self, self._root)
            elif _on == Wmo.M2arrayTypes.m2compquat:
                self.values = Wmo.M2array(Wmo.M2arrayTypes.m2compquat, self._io, self, self._root)
    ...
    class ChunkMopr(KaitaiStruct):
        """Map Object Portal References.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MOPR_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            self.portal_references = []
            i = 0
            while not self._io.is_eof():
                self.portal_references.append(Wmo.PortalReferenceList(self._io, self, self._root))
                i += 1



    class ChunkMopt(KaitaiStruct):
        """Map Object Portal Information.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MOPT_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            ...
            i = 0
            while not self._io.is_eof():
                self.portal_info.append(Wmo.PortalInfo(self._io, self, self._root))
                i += 1
    ...
    class M2box(KaitaiStruct):
        ...
        def _read(self):
            self.model_rotation_speed_min = Wmo.C3vector(self._io, self, self._root)
            self.model_rotation_speed_max = Wmo.C3vector(self._io, self, self._root)


    class DoodadDefinitionList(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            self.name_index = self._io.read_bits_int_le(24)
            self.accept_projected = self._io.read_bits_int_le(1) != 0
            self.unknown1 = self._io.read_bits_int_le(1) != 0
            self.unknown2 = self._io.read_bits_int_le(1) != 0
            self.unknown3 = self._io.read_bits_int_le(1) != 0
            self._io.align_to_byte()
            self.position = Wmo.C3vector(self._io, self, self._root)
            self.orientation = Wmo.C4quaternion(self._io, self, self._root)
    ...
    class Caabox(KaitaiStruct):
        ...
        def _read(self):
            self.min = Wmo.C3vector(self._io, self, self._root)
            self.max = Wmo.C3vector(self._io, self, self._root)


    class ChunkGfid(KaitaiStruct):
        """Map Object Group File Data IDs.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#GFID_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            ...
            i = 0
            while not self._io.is_eof():
                self.group_file_data_ids.append(self._io.read_u4le())
                i += 1
    ...
    class M2skinsection(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.center_position = Wmo.C3vector(self._io, self, self._root)
            self.sort_center_position = Wmo.C3vector(self._io, self, self._root)
    ...
    class PolyListFlags(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            self.unknown1 = self._io.read_bits_int_le(1) != 0
            self.no_cam_collide = self._io.read_bits_int_le(1) != 0
            self.detail = self._io.read_bits_int_le(1) != 0
            self.collision = self._io.read_bits_int_le(1) != 0
            self.hint = self._io.read_bits_int_le(1) != 0
            self.render = self._io.read_bits_int_le(1) != 0
            self.unknown2 = self._io.read_bits_int_le(1) != 0
            self.collide_hit = self._io.read_bits_int_le(1) != 0
    ...
    class FogsInfo(KaitaiStruct):
        ...
        def _read(self):
            self.flags = Wmo.FogInfoFlags(self._io, self, self._root)
            self.pos = Wmo.C3vector(self._io, self, self._root)
            self.smaller_radius = self._io.read_f4le()
            self.larger_radius = self._io.read_f4le()
            self.fogs = [None] * (2)
            for i in range(2):
                self.fogs[i] = Wmo.FogInfo(self._io, self, self._root)
    ...
    class M2attachment(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.unknown1 = self._io.read_u2le()
            self.position = Wmo.C3vector(self._io, self, self._root)
            self.animate_attached = Wmo.M2track(Wmo.M2trackTypes.uint8, self._io, self, self._root)
    ...
    class M2ribbon(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.color_track = Wmo.M2track(Wmo.M2trackTypes.c3vector, self._io, self, self._root)
            self.alpha_track = Wmo.M2track(Wmo.M2trackTypes.fixed16, self._io, self, self._root)
            self.height_above_track = Wmo.M2track(Wmo.M2trackTypes.float, self._io, self, self._root)
            self.height_below_track = Wmo.M2track(Wmo.M2trackTypes.float, self._io, self, self._root)
            ...
            self.tex_slot_track = Wmo.M2track(Wmo.M2trackTypes.uint16, self._io, self, self._root)
            self.visibility_track = Wmo.M2track(Wmo.M2trackTypes.uint8, self._io, self, self._root)
    ...
    class BatchList(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.material_id_large = self._io.read_u2le()
            self.start_index = self._io.read_u4le()
            self.count = self._io.read_u2le()
            self.min_index = self._io.read_u2le()
            self.max_index = self._io.read_u2le()
            self.flags = Wmo.BatchListFlags(self._io, self, self._root)
            self.material_id = self._io.read_u1()


    class ChunkModd(KaitaiStruct):
        """Map Object Doodad Definition - Documentation is extensive, please see URL.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MODD_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            ...
            i = 0
            while not self._io.is_eof():
                self.doodad_defs.append(Wmo.DoodadDefinitionList(self._io, self, self._root))
                i += 1



    class ChunkMods(KaitaiStruct):
        """Map Object Doodad Sets.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MODS_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            ...
            i = 0
            while not self._io.is_eof():
                self.doodad_sets.append(Wmo.DoodadSetList(self._io, self, self._root))
                i += 1



    class ChunkMopy(KaitaiStruct):
        """Map Object Poly List - Material info for triangles, two bytes per triangle.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MOPY_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            ...
            i = 0
            while not self._io.is_eof():
                self.polys.append(Wmo.PolyList(self._io, self, self._root))
                i += 1



    class ChunkMobn(KaitaiStruct):
        """Map Object BSP Nodes.
        
        .. seealso::
           Source - https://wowdev.wiki/WMO#MOBN_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            ...
            i = 0
            while not self._io.is_eof():
                self.bspnodes.append(Wmo.Bspnode(self._io, self, self._root))
                i += 1
