...
class Adt(KaitaiStruct):
    ...
    def _read(self):
        ...
        while not self._io.is_eof():
            self.chunks.append(Adt.AdtChunk(self._io, self, self._root))
            i += 1
    ...
    class C3segment(KaitaiStruct):
        ...
        def _read(self):
            self.start = Adt.C3vector(self._io, self, self._root)
            self.end = Adt.C3vector(self._io, self, self._root)
    ...
    class M2light(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.position = Adt.C3vector(self._io, self, self._root)
            self.ambient_color = Adt.M2track(Adt.M2trackTypes.c3vector, self._io, self, self._root)
            self.ambient_intensity = Adt.M2track(Adt.M2trackTypes.float, self._io, self, self._root)
            self.diffuse_color = Adt.M2track(Adt.M2trackTypes.c3vector, self._io, self, self._root)
            self.diffuse_intensity = Adt.M2track(Adt.M2trackTypes.float, self._io, self, self._root)
            self.attenuation_start = Adt.M2track(Adt.M2trackTypes.float, self._io, self, self._root)
            self.attenuation_end = Adt.M2track(Adt.M2trackTypes.float, self._io, self, self._root)
            self.visibility = Adt.M2track(Adt.M2trackTypes.uint8, self._io, self, self._root)
    ...
    class M2extendedParticle(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.unknown3 = Adt.M2parttrack(Adt.M2arrayTypes.fixed16, self._io, self, self._root)


    class MhdrFlags(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            self.has_mfbo = self._io.read_bits_int_le(1) != 0
            self.northrend = self._io.read_bits_int_le(1) != 0
    ...
    class M2sequence(KaitaiStruct):
        ...
        def _read(self):
            self.id = KaitaiStream.resolve_enum(Adt.AnimNames, self._io.read_u2le())
            ...
            self.flags = Adt.M2sequenceFlags(_io__raw_flags, self, self._root)
            self.frequency = self._io.read_s2le()
            self.padding = self._io.read_u2le()
            self.replay = Adt.M2range(self._io, self, self._root)
            self.blend_time_in = self._io.read_u2le()
            self.blend_time_out = self._io.read_u2le()
            self.bounds = Adt.M2bounds(self._io, self, self._root)
    ...
    class M2texturetransform(KaitaiStruct):
        ...
        def _read(self):
            self.translation = Adt.M2track(Adt.M2trackTypes.c3vector, self._io, self, self._root)
            self.rotation = Adt.M2track(Adt.M2trackTypes.c4quaternion, self._io, self, self._root)
            self.scaling = Adt.M2track(Adt.M2trackTypes.c3vector, self._io, self, self._root)
    ...
    class M2particleOld(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.flags = Adt.M2particlesFlags(self._io, self, self._root)
            self.position = Adt.C3vector(self._io, self, self._root)
            ...
            self.blending_type = KaitaiStream.resolve_enum(Adt.Blendmodes, self._io.read_u1())
            self.emitter_type = KaitaiStream.resolve_enum(Adt.EmitterTypes, self._io.read_u1())
            ...
            self.emission_speed = Adt.M2track(Adt.M2trackTypes.float, self._io, self, self._root)
            self.speed_variation = Adt.M2track(Adt.M2trackTypes.float, self._io, self, self._root)
            self.vertical_range = Adt.M2track(Adt.M2trackTypes.float, self._io, self, self._root)
            self.horizontal_range = Adt.M2track(Adt.M2trackTypes.float, self._io, self, self._root)
            self.gravity = Adt.M2track(Adt.M2trackTypes.float, self._io, self, self._root)
            self.lifespan = Adt.M2track(Adt.M2trackTypes.float, self._io, self, self._root)
            self.lifespan_vary = self._io.read_f4le()
            self.emission_rate = Adt.M2track(Adt.M2trackTypes.float, self._io, self, self._root)
            self.emission_rate_vary = self._io.read_f4le()
            self.emission_area_length = Adt.M2track(Adt.M2trackTypes.float, self._io, self, self._root)
            self.emission_area_width = Adt.M2track(Adt.M2trackTypes.float, self._io, self, self._root)
            self.z_source = Adt.M2track(Adt.M2trackTypes.float, self._io, self, self._root)
            self.p = Adt.ModelParticleParams(self._io, self, self._root)
            self.enabled_in = Adt.M2track(Adt.M2trackTypes.uint16, self._io, self, self._root)
    ...
    class Mh2oAttributes(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            self.fishable = self._io.read_u8le()
            self.deep = self._io.read_u8le()
    ...
    class Cfacet(KaitaiStruct):
        ...
        def _read(self):
            self.plane = Adt.C4plane(self._io, self, self._root)
            self.vertices = [None] * (3)
            for i in range(3):
                self.vertices[i] = Adt.C3vector(self._io, self, self._root)
    ...
    class M2array(KaitaiStruct):
        ...
        def values(self):
            ...
            for i in range(self.num):
                ...
                if _on == Adt.M2arrayTypes.fixed16:
                    self._m_values[i] = Adt.Fixed16(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2ribbon:
                    self._m_values[i] = Adt.M2ribbon(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.int16:
                    self._m_values[i] = self._io.read_s2le()
                elif _on == Adt.M2arrayTypes.m2array_c4quaternion:
                    self._m_values[i] = Adt.M2array(Adt.M2arrayTypes.c4quaternion, self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2vertex:
                    self._m_values[i] = Adt.M2vertex(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2light:
                    self._m_values[i] = Adt.M2light(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2sequence:
                    self._m_values[i] = Adt.M2sequence(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2array_fixed16:
                    self._m_values[i] = Adt.M2array(Adt.M2arrayTypes.fixed16, self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2array_c3vector:
                    self._m_values[i] = Adt.M2array(Adt.M2arrayTypes.c3vector, self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2loop:
                    self._m_values[i] = Adt.M2loop(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2sequencefallback:
                    self._m_values[i] = Adt.M2sequencefallback(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.uint8:
                    self._m_values[i] = self._io.read_u1()
                elif _on == Adt.M2arrayTypes.uint32:
                    self._m_values[i] = self._io.read_u4le()
                elif _on == Adt.M2arrayTypes.todo:
                    self._m_values[i] = Adt.M2arrayTodo(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2event:
                    self._m_values[i] = Adt.M2event(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.c4quaternion:
                    self._m_values[i] = Adt.C4quaternion(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2texturetransform:
                    self._m_values[i] = Adt.M2texturetransform(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.c3vector:
                    self._m_values[i] = Adt.C3vector(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2particle:
                    self._m_values[i] = Adt.M2particle(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2color:
                    self._m_values[i] = Adt.M2color(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2shadowbatch:
                    self._m_values[i] = Adt.M2shadowbatch(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.float:
                    self._m_values[i] = self._io.read_f4le()
                elif _on == Adt.M2arrayTypes.c4vector:
                    self._m_values[i] = Adt.C4vector(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2texture:
                    self._m_values[i] = Adt.M2texture(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.c2vector:
                    self._m_values[i] = Adt.C2vector(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2array_c4vector:
                    self._m_values[i] = Adt.M2array(Adt.M2arrayTypes.c4vector, self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2extended_particle:
                    self._m_values[i] = Adt.M2extendedParticle(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.uint16:
                    self._m_values[i] = self._io.read_u2le()
                elif _on == Adt.M2arrayTypes.m2array_m2compquat:
                    self._m_values[i] = Adt.M2array(Adt.M2arrayTypes.m2compquat, self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2attachment:
                    self._m_values[i] = Adt.M2attachment(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.int8:
                    self._m_values[i] = self._io.read_s1()
                elif _on == Adt.M2arrayTypes.m2array_float:
                    self._m_values[i] = Adt.M2array(Adt.M2arrayTypes.float, self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2array_c2vector:
                    self._m_values[i] = Adt.M2array(Adt.M2arrayTypes.c2vector, self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.frgb:
                    self._m_values[i] = Adt.Frgb(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2material:
                    self._m_values[i] = Adt.M2material(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2array_uint32:
                    self._m_values[i] = Adt.M2array(Adt.M2arrayTypes.uint32, self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2compquat:
                    self._m_values[i] = Adt.M2compquat(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.ubyte4:
                    self._m_values[i] = Adt.Ubyte4(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2camera:
                    self._m_values[i] = Adt.M2camera(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2compbone:
                    self._m_values[i] = Adt.M2compbone(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.pgd1_entry:
                    self._m_values[i] = Adt.Pgd1Entry(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2array_uint16:
                    self._m_values[i] = Adt.M2array(Adt.M2arrayTypes.uint16, self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2batch:
                    self._m_values[i] = Adt.M2batch(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2skinsection:
                    self._m_values[i] = Adt.M2skinsection(self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2array_uint8:
                    self._m_values[i] = Adt.M2array(Adt.M2arrayTypes.uint8, self._io, self, self._root)
                elif _on == Adt.M2arrayTypes.m2textureweight:
                    self._m_values[i] = Adt.M2textureweight(self._io, self, self._root)
    ...
    class M2textureweight(KaitaiStruct):
        ...
        def _read(self):
            self.weight = Adt.M2track(Adt.M2trackTypes.fixed16, self._io, self, self._root)
    ...
    class M2bounds(KaitaiStruct):
        ...
        def _read(self):
            self.extent = Adt.Caabox(self._io, self, self._root)
    ...
    class M2camera(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.positions = Adt.M2track(Adt.M2trackTypes.todo, self._io, self, self._root)
            self.position_base = Adt.C3vector(self._io, self, self._root)
            self.target_position = Adt.M2track(Adt.M2trackTypes.todo, self._io, self, self._root)
            self.target_position_base = Adt.C3vector(self._io, self, self._root)
            self.roll = Adt.M2track(Adt.M2trackTypes.todo, self._io, self, self._root)
            self.fov = Adt.M2track(Adt.M2trackTypes.todo, self._io, self, self._root)
    ...
    class C34matrix(KaitaiStruct):
        ...
        def _read(self):
            self.columns = [None] * (4)
            for i in range(4):
                self.columns[i] = Adt.C3vector(self._io, self, self._root)



    class ChunkMcnk(KaitaiStruct):
        """Map Tile Chunks. Always come in 256 individual chunks. Each chunk has 9x9 verts, with 8x8 additional verts in-between, plus several texture layers, normal vectors, shadow map, etc. Offsets to sub-chunks are relative to beginning of MCNK chunk, not MCNK chunk data.
        ...
        def _read(self):
            self._raw_flags = self._io.read_bytes(4)
            _io__raw_flags = KaitaiStream(BytesIO(self._raw_flags))
            self.flags = Adt.McnkFlags(_io__raw_flags, self, self._root)
            self.index_x = self._io.read_u4le()
            self.index_y = self._io.read_u4le()
            self.num_layers = self._io.read_u4le()
            if not self.num_layers <= 4:
                raise kaitaistruct.ValidationGreaterThanError(4, self.num_layers, self._io, u"/types/chunk_mcnk/seq/3")
            self.num_doodad_refs = self._io.read_u4le()
            self.holes_high_res = self._io.read_u8le()
            self.ofs_layer = self._io.read_u4le()
            self.ofs_refs = self._io.read_u4le()
            self.ofs_alpha = self._io.read_u4le()
            self.size_alpha = self._io.read_u4le()
            self.ofs_shadow = self._io.read_u4le()
            self.size_shadow = self._io.read_u4le()
            self.area_id = self._io.read_u4le()
            self.num_map_obj_refs = self._io.read_u4le()
            self.holes_low_res = self._io.read_u2le()
            self.unknown1 = self._io.read_u2le()
            self.really_low_quality_texturing_map = [None] * ((8 * 8))
            for i in range((8 * 8)):
                self.really_low_quality_texturing_map[i] = self._io.read_bits_int_le(2)

            self.no_effect_doodad = [None] * ((8 * 8))
            for i in range((8 * 8)):
                self.no_effect_doodad[i] = self._io.read_bits_int_le(1) != 0

            self._io.align_to_byte()
            self.ofs_sound_emitters = self._io.read_u4le()
            self.num_sound_emitters = self._io.read_u4le()
            self.ofs_liquids = self._io.read_u4le()
            self.size_liquids = self._io.read_u4le()
            self.position = Adt.C3vector(self._io, self, self._root)
            self.ofs_mccv = self._io.read_u4le()
            self.ofs_mclv = self._io.read_u4le()
    ...
    class C3ray(KaitaiStruct):
        ...
        def _read(self):
            self.origin = Adt.C3vector(self._io, self, self._root)
            self.dir = Adt.C3vector(self._io, self, self._root)
    ...
    class C4plane(KaitaiStruct):
        ...
        def _read(self):
            self.normal = Adt.C3vector(self._io, self, self._root)
            self.distance = self._io.read_f4le()


    class Mh2oInstances(KaitaiStruct):
        ...
        def _read(self):
            self.foreign_key = self._io.read_u2le()
            self.min_height_level = self._io.read_f4le()
            self.max_height_level = self._io.read_f4le()
            self.x_offset = self._io.read_u1()
            self.y_offset = self._io.read_u1()
            self.width = self._io.read_u1()
            self.height = self._io.read_u1()
            self.ofs_exists_bitmap = self._io.read_u4le()
            self.ofs_vertex_data = self._io.read_u4le()
    ...
    class M2material(KaitaiStruct):
        ...
        def _read(self):
            ...
            _io__raw_flags = KaitaiStream(BytesIO(self._raw_flags))
            self.flags = Adt.M2materialFlags(_io__raw_flags, self, self._root)
            self.blending_mode = KaitaiStream.resolve_enum(Adt.M2materialBlendmodes, self._io.read_u2le())
    ...
    class M2color(KaitaiStruct):
        ...
        def _read(self):
            self.color = Adt.M2track(Adt.M2trackTypes.c3vector, self._io, self, self._root)
            self.alpha = Adt.M2track(Adt.M2trackTypes.fixed16, self._io, self, self._root)
    ...
    class ModelParticleParams(KaitaiStruct):
        ...
        def _read(self):
            self.colors = Adt.Fblock(Adt.M2arrayTypes.frgb, self._io, self, self._root)
            self.opacity = Adt.Fblock(Adt.M2arrayTypes.uint16, self._io, self, self._root)
            self.sizes = Adt.Fblock(Adt.M2arrayTypes.c2vector, self._io, self, self._root)
            self.d = [None] * (2)
            for i in range(2):
                self.d[i] = self._io.read_u4le()

            self.intensity = Adt.Fblock(Adt.M2arrayTypes.uint16, self._io, self, self._root)
            self.unk2 = Adt.Fblock(Adt.M2arrayTypes.uint16, self._io, self, self._root)
            self.unk = [None] * (3)
            for i in range(3):
                self.unk[i] = self._io.read_f4le()

            self.scales = Adt.C3vector(self._io, self, self._root)
            ...
            self.rot1 = Adt.C3vector(self._io, self, self._root)
            self.rot2 = Adt.C3vector(self._io, self, self._root)
            self.trans = Adt.C3vector(self._io, self, self._root)
            self.f2 = [None] * (4)
            for i in range(4):
                self.f2[i] = self._io.read_f4le()

            self.unknown_reference = Adt.M2array(Adt.M2arrayTypes.todo, self._io, self, self._root)
    ...
    class M2event(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.position = Adt.C3vector(self._io, self, self._root)
            self.enabled = Adt.M2trackbase(self._io, self, self._root)
    ...
    class M2texture(KaitaiStruct):
        ...
        def _read(self):
            self.type = KaitaiStream.resolve_enum(Adt.M2textureTypes, self._io.read_u4le())
            self._raw_flags = self._io.read_bytes(4)
            _io__raw_flags = KaitaiStream(BytesIO(self._raw_flags))
            self.flags = Adt.M2textureFlags(_io__raw_flags, self, self._root)
            if True:
    ...
    class M2compbone(KaitaiStruct):
        ...
        def _read(self):
            ...
            self._raw_flags = self._io.read_bytes(4)
            _io__raw_flags = KaitaiStream(BytesIO(self._raw_flags))
            self.flags = Adt.M2compboneFlags(_io__raw_flags, self, self._root)
            self.parent_bone = self._io.read_s2le()
            self.submesh_id = self._io.read_u2le()
            self.bone_name_crc = self._io.read_u4le()
            self.translation = Adt.M2track(Adt.M2trackTypes.c3vector, self._io, self, self._root)
            self.rotation = Adt.M2track(Adt.M2trackTypes.m2compquat, self._io, self, self._root)
            self.scale = Adt.M2track(Adt.M2trackTypes.c3vector, self._io, self, self._root)
            self.pivot = Adt.C3vector(self._io, self, self._root)
    ...
    class M2vertex(KaitaiStruct):
        ...
        def _read(self):
            self.pos = Adt.C3vector(self._io, self, self._root)
            ...
            for i in range(2):
                self.tex_coords[i] = Adt.C2vector(self._io, self, self._root)
    ...
    class M2track(KaitaiStruct):
        ...
        def _read(self):
            self.interpolation_type = KaitaiStream.resolve_enum(Adt.M2trackInterpolationTypes, self._io.read_u2le())
            ...
            if _on == Adt.M2trackTypes.uint8:
                self.values = Adt.M2array(Adt.M2arrayTypes.m2array_uint8, self._io, self, self._root)
            elif _on == Adt.M2trackTypes.c2vector:
                self.values = Adt.M2array(Adt.M2arrayTypes.m2array_c2vector, self._io, self, self._root)
            elif _on == Adt.M2trackTypes.c4quaternion:
                self.values = Adt.M2array(Adt.M2arrayTypes.m2array_c4quaternion, self._io, self, self._root)
            elif _on == Adt.M2trackTypes.m2compquat:
                self.values = Adt.M2array(Adt.M2arrayTypes.m2array_m2compquat, self._io, self, self._root)
            elif _on == Adt.M2trackTypes.uint16:
                self.values = Adt.M2array(Adt.M2arrayTypes.m2array_uint16, self._io, self, self._root)
            elif _on == Adt.M2trackTypes.float:
                self.values = Adt.M2array(Adt.M2arrayTypes.m2array_float, self._io, self, self._root)
            elif _on == Adt.M2trackTypes.fixed16:
                self.values = Adt.M2array(Adt.M2arrayTypes.m2array_fixed16, self._io, self, self._root)
            elif _on == Adt.M2trackTypes.todo:
                self.values = Adt.M2array(Adt.M2arrayTypes.todo, self._io, self, self._root)
            elif _on == Adt.M2trackTypes.c3vector:
                self.values = Adt.M2array(Adt.M2arrayTypes.m2array_c3vector, self._io, self, self._root)
        ...
        def timestamps(self):
            ...
            if True:
                ...
                for i in range(self.num_timestamps):
                    self._m_timestamps[i] = Adt.U4Nested(self._io, self, self._root)
    ...
    class M2parttrack(KaitaiStruct):
        ...
        def _read(self):
            self.times = Adt.M2array(Adt.M2arrayTypes.fixed16, self._io, self, self._root)
            _on = self.m2array_type
            if _on == Adt.M2arrayTypes.fixed16:
                self.values = Adt.M2array(Adt.M2arrayTypes.fixed16, self._io, self, self._root)
    ...
    class Vector2fp69(KaitaiStruct):
        ...
        def _read(self):
            self.x = Adt.Fp69(self._io, self, self._root)
            self.y = Adt.Fp69(self._io, self, self._root)


    class McnkFlags(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            self.has_mcsh = self._io.read_bits_int_le(1) != 0
            self.impass = self._io.read_bits_int_le(1) != 0
            self.lq_river = self._io.read_bits_int_le(1) != 0
            self.lq_ocean = self._io.read_bits_int_le(1) != 0
            self.lq_magma = self._io.read_bits_int_le(1) != 0
            self.lq_slime = self._io.read_bits_int_le(1) != 0
            self.has_mccv = self._io.read_bits_int_le(1) != 0
            self.unknown1 = self._io.read_bits_int_le(1) != 0
            self.unused1 = self._io.read_bits_int_le(7)
            self.do_not_fix_alpha_map = self._io.read_bits_int_le(1) != 0
            self.high_res_holes = self._io.read_bits_int_le(1) != 0
            self.unused2 = self._io.read_bits_int_le(15)
    ...
    class M2trackbase(KaitaiStruct):
        ...
        def _read(self):
            self.interpolation_type = KaitaiStream.resolve_enum(Adt.M2trackInterpolationTypes, self._io.read_u2le())
            self.global_sequence = self._io.read_s2le()
            self.timestamps = Adt.M2array(Adt.M2arrayTypes.m2array_uint32, self._io, self, self._root)
    ...
    class M2particle(KaitaiStruct):
        ...
        def _read(self):
            self.old = Adt.M2particleOld(self._io, self, self._root)
            self.multi_texture_param0 = [None] * (2)
            for i in range(2):
                self.multi_texture_param0[i] = Adt.Vector2fp69(self._io, self, self._root)

            self.multi_texture_param1 = [None] * (2)
            for i in range(2):
                self.multi_texture_param1[i] = Adt.Vector2fp69(self._io, self, self._root)



    class Mh2oHeader(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            self.ofs_instances = self._io.read_u4le()
            self.num_layers = self._io.read_u4le()
        ...
        def attributes(self):
            if hasattr(self, '_m_attributes'):
                return self._m_attributes if hasattr(self, '_m_attributes') else None

            _pos = self._io.pos()
            self._io.seek(self.ofs_attributes)
            self._m_attributes = Adt.Mh2oAttributes(self._io, self, self._root)
            self._io.seek(_pos)
            return self._m_attributes if hasattr(self, '_m_attributes') else None

        @property
        def instances(self):
            if hasattr(self, '_m_instances'):
                return self._m_instances if hasattr(self, '_m_instances') else None

            _pos = self._io.pos()
            self._io.seek(self.ofs_instances)
            self._m_instances = [None] * (self.num_layers)
            for i in range(self.num_layers):
                self._m_instances[i] = Adt.Mh2oInstances(self._io, self, self._root)
    ...
    class Fblock(KaitaiStruct):
        ...
        def _read(self):
            self.timestamps = Adt.M2array(Adt.M2arrayTypes.uint16, self._io, self, self._root)
            _on = self.m2array_type
            if _on == Adt.M2arrayTypes.fixed16:
                self.values = Adt.M2array(Adt.M2arrayTypes.fixed16, self._io, self, self._root)
            elif _on == Adt.M2arrayTypes.uint8:
                self.values = Adt.M2array(Adt.M2arrayTypes.uint8, self._io, self, self._root)
            elif _on == Adt.M2arrayTypes.todo:
                self.values = Adt.M2array(Adt.M2arrayTypes.todo, self._io, self, self._root)
            elif _on == Adt.M2arrayTypes.c4quaternion:
                self.values = Adt.M2array(Adt.M2arrayTypes.c4quaternion, self._io, self, self._root)
            elif _on == Adt.M2arrayTypes.c3vector:
                self.values = Adt.M2array(Adt.M2arrayTypes.c3vector, self._io, self, self._root)
            elif _on == Adt.M2arrayTypes.float:
                self.values = Adt.M2array(Adt.M2arrayTypes.float, self._io, self, self._root)
            elif _on == Adt.M2arrayTypes.c4vector:
                self.values = Adt.M2array(Adt.M2arrayTypes.c4vector, self._io, self, self._root)
            elif _on == Adt.M2arrayTypes.c2vector:
                self.values = Adt.M2array(Adt.M2arrayTypes.c2vector, self._io, self, self._root)
            elif _on == Adt.M2arrayTypes.uint16:
                self.values = Adt.M2array(Adt.M2arrayTypes.uint16, self._io, self, self._root)
            elif _on == Adt.M2arrayTypes.frgb:
                self.values = Adt.M2array(Adt.M2arrayTypes.frgb, self._io, self, self._root)
            elif _on == Adt.M2arrayTypes.m2compquat:
                self.values = Adt.M2array(Adt.M2arrayTypes.m2compquat, self._io, self, self._root)


    class AdtChunk(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            ...
            if _on == u"MCNK":
                ...
                self.chunk_data = Adt.ChunkMcnk(_io__raw_chunk_data, self, self._root)
            elif _on == u"MH2O":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Adt.ChunkMh2o(_io__raw_chunk_data, self, self._root)
            elif _on == u"MHDR":
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Adt.ChunkMhdr(_io__raw_chunk_data, self, self._root)
            else:
                self._raw_chunk_data = self._io.read_bytes(self.chunk_size)
                _io__raw_chunk_data = KaitaiStream(BytesIO(self._raw_chunk_data))
                self.chunk_data = Adt.Noop(_io__raw_chunk_data, self, self._root)
    ...
    class M2box(KaitaiStruct):
        ...
        def _read(self):
            self.model_rotation_speed_min = Adt.C3vector(self._io, self, self._root)
            self.model_rotation_speed_max = Adt.C3vector(self._io, self, self._root)


    class ChunkMhdr(KaitaiStruct):
        """Map Tile Header.
        
        .. seealso::
           Source - https://wowdev.wiki/ADT/v18#MHDR_chunk
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            self._raw_flags = self._io.read_bytes(4)
            _io__raw_flags = KaitaiStream(BytesIO(self._raw_flags))
            self.flags = Adt.MhdrFlags(_io__raw_flags, self, self._root)
            self.ofs_mcin = self._io.read_u4le()
            self.ofs_mtex = self._io.read_u4le()
            self.ofs_mmdx = self._io.read_u4le()
            self.ofs_mmid = self._io.read_u4le()
            self.ofs_mwmo = self._io.read_u4le()
            self.ofs_mwid = self._io.read_u4le()
            self.ofs_mddf = self._io.read_u4le()
            self.ofs_modf = self._io.read_u4le()
            self.ofs_mfbo = self._io.read_u4le()
            self.ofs_mh2o = self._io.read_u4le()
            self.ofs_mtxf = self._io.read_u4le()
            self.mamp_value = self._io.read_u1()
            self.padding = [None] * (3)
            for i in range(3):
            ...
            self.unused = [None] * (3)
            for i in range(3):
                self.unused[i] = self._io.read_u4le()
    ...
    class Caabox(KaitaiStruct):
        ...
        def _read(self):
            self.min = Adt.C3vector(self._io, self, self._root)
            self.max = Adt.C3vector(self._io, self, self._root)
    ...
    class M2skinsection(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.center_position = Adt.C3vector(self._io, self, self._root)
            self.sort_center_position = Adt.C3vector(self._io, self, self._root)
    ...
    class ChunkMh2o(KaitaiStruct):
        """Map Tile Liquids.
        
        .. seealso::
           Source - https://wowdev.wiki/ADT/v18#MH2O_chunk_.28WotLK.2B.29
        """
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
        ...
        def _read(self):
            self.liquid_chunks = [None] * ((16 * 16))
            for i in range((16 * 16)):
                self.liquid_chunks[i] = Adt.Mh2oHeader(self._io, self, self._root)
    ...
    class M2attachment(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.unknown1 = self._io.read_u2le()
            self.position = Adt.C3vector(self._io, self, self._root)
            self.animate_attached = Adt.M2track(Adt.M2trackTypes.uint8, self._io, self, self._root)
    ...
    class M2ribbon(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.color_track = Adt.M2track(Adt.M2trackTypes.c3vector, self._io, self, self._root)
            self.alpha_track = Adt.M2track(Adt.M2trackTypes.fixed16, self._io, self, self._root)
            self.height_above_track = Adt.M2track(Adt.M2trackTypes.float, self._io, self, self._root)
            self.height_below_track = Adt.M2track(Adt.M2trackTypes.float, self._io, self, self._root)
            ...
            self.tex_slot_track = Adt.M2track(Adt.M2trackTypes.uint16, self._io, self, self._root)
            self.visibility_track = Adt.M2track(Adt.M2trackTypes.uint8, self._io, self, self._root)
